...
<%@ include file="../../inc/hd.jsp"%>
	...
	<div class="cont_pn"> 
	<form name="frm" method="post" action="part3_save.jsp" onSubmit="return CheckAndSubmit(this)">
		<input type="hidden" name="wmode" value="R"/>
		...
		<table cellspacing="0" summary="" class="tbT03 tbnone">
			...
			<tr>
				<th>전화번호</th>
				<td><input type="text" name="phone" class="input" value="<%=phone%>"></td>	
			</tr>
			<tr>
				<th>이메일</th>
				<td>
					...
					<input type="checkbox" name="mailyn" value="Y" checked="<%=mailyn.equals("Y")?"checked":""%>">
					<label for=""><img src="../../images/check_msg.gif"></label> 				
				</td>	
			</tr>
			<tr>
				<th>우편번호</th>
				<td><input type="text" name="post_cd1" class="input" value="<%=post1%>"> - <input type="text" name="post_cd2" class="input" value="<%=post2%>"><a href="javascript:toPost()" class="inputzip">우편번호검색</a></td>	
			</tr>
			<tr class="none">
				<th>주소</th>
				<td><input type="text" name="addr" class="input" style="width:97%;" value="<%=addr1+addr2%>"></td>	
			</tr>				
			</tbody>
		</table>
