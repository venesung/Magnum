...
var Rolling = (function ($) {
    var wddoObj = function () {
        ...
        function up() {
            ...
            if (exUp !== undefined) exUp(count);
			if (!isRepeat && exDot !== undefined) exDot(count);
        }
        ...
        function down() {
            ...
            if (exDown !== undefined) exDown(count);
			if (!isRepeat && exDot !== undefined) exDot(count);
        }
        ...
        //motion function
        function motion(ypos) {
            showAtag();
                   
            if (direction === 'horizontal') {
                $itemContainer.stop().animate( {'marginLeft': ypos + "px"},
                                        {queue:false, duration:speed, easing: ease, complete:motionComplete}
                );  
            } else {
                $itemContainer.stop().animate( {'marginTop': ypos + "px"},
                                        {queue:false, duration:speed, easing: ease, complete:motionComplete}
                );
            }
        }
        ...
        function motionComplete () {
            hideAtag();
            if (exComplete !== undefined) exComplete(count);
        }
