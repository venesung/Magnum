...
<title>GIFT Special 제 5탄 壬辰年 새해 선물 - 삼성카드</title>
<style type="text/css">
...
.giftevent_btm	{width:728px; height:20px; background:url('/html/et/spcialgift5/images/bg_tmp_btm.gif') no-repeat}
.giftevent	{height:100%; background:url('/html/et/spcialgift5/images/bg_tmp_mid.gif') repeat-y; padding:0 49px}
...
.gift_bg	{position:relative; width:630px; height:181px; background:url('/html/et/spcialgift5/images/bg_event_gift.jpg') no-repeat; margin-bottom:10px}
...
.box_white	 {position:relative; background:white url('/html/et/spcialgift5/images/box_white.gif') no-repeat}
...
.box_white_btm	 {padding:10px; background:url('/html/et/spcialgift5/images/box_white.gif') no-repeat right bottom}
...
<script language="javascript" type="text/javascript">
		...
		function pop201102() {
			window.open('/html/et/spcialgift5/event.html','pop201112','menubar=0,resizable=0,scrollbars=0,width=710,height=610,left=0,top=0');
		}
function applyEvent() {
		var chkCheckbox = "N";
...
<%}%>
		...
		document.form1.action="/hp/im/et/evt.do?method=applySpecialGiftEvent5";
...
<div id="special_gift">
<!-- 수정 110926 -->
	<p><img src="/html/et/spcialgift5/images/event_gift_special05_login.jpg" alt="이벤트 참여하기" usemap="#gift" /></p>
<!-- //수정 110926 -->
</div>

<map name="gift" id="gift">
 <area shape="rect" coords="309,768,409,798" href="#" onclick="parent.eventLogin('12070');" alt="로그인" />
</map>
...
<div id="special_gift">
	...
	<p><img src="/html/et/spcialgift5/images/event_gift_special_top5.jpg" alt="GIFT Special 제 5탄 壬辰年 새해 선물" /></p>
	<div class="giftevent">
		<p class="al_center mb10"><a id="NHPIMETEVTVIEW446_L01" href="#" onclick="document.getElementById('id_layer').style.display='block';fnSetReturnFocusId('NHPIMETEVTVIEW446_L01','id_layer');">
		<img src="/html/et/spcialgift5/images/btn_payview.gif" alt="현재까지 이용금액 보기" /></a></p>

		<!-- 목표금액 설정 -->
		<h1><img src="/html/et/spcialgift5/images/h1_step01.gif" alt="STEP 01. 목표금액을 설정해주세요." />지난 2개월간 고객님의 평균 실적은 <strong class="t_point_org t_no"><%=StringUtil.replace(approveSum,".5","") %></strong>원 입니다.</h1>
        ...
        <caption>목표이용금액 설정</caption>
			...
			<tbody>
				<tr>
					...
					<td>
<!-- 수정 110214 -->
						<select name="objectAmount" style="width:200px" onchange="javascript:chgSel();">
...
<!-- // 수정 110214 -->
		...
		<!-- // 목표금액 설정 -->
		<!-- 경품선택 -->
		<h1><img src="/html/et/spcialgift5/images/h1_step02.gif" alt="STEP 02. 경품을 선택 헤주세요." />
		<a href="#" onclick="pop201102();" title="새창"><img src="/html/et/spcialgift5/images/btn_countryview2.gif" alt="경품 자세히 보기" /></a></h1>
<!-- 수정 110217 -->
		<!-- 1000만원 이상 -->
		<h2 class="gift1"><img src="/html/et/spcialgift5/images/h2_gift_1000.gif" alt="01. 목표금액이 500만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/html/et/spcialgift5/images/img_gift1000_01.gif" alt="삼성 양문형 냉장고 669L SRS68HCBGG1" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="01" title="삼성 양문형 냉장고 669L SRS68HCBGG (1명)" />삼성 양문형 냉장고 669L<br /> SRS68HCBGG (<span class="ls0">1</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='1' req_cnt='<%=String.valueOf(grade01) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/html/et/spcialgift5/images/img_gift1000_02.gif" alt="동양매직 식기세척기 DWA-6702H" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="02" title="동양매직 식기세척기 DWA-6702H (3명)" />동양매직 식기세척기<br />  DWA-6702H (<span class="ls0">3</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='3' req_cnt='<%=String.valueOf(grade02) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/html/et/spcialgift5/images/img_gift1000_03.gif" alt="캐시백 5만원" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="03" title="캐시백 5만원" />캐시백 <span class="ls0">5</span>만원<br /> (<span class="ls0">10</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='10' req_cnt='<%=String.valueOf(grade03) %>' inputCss="" /></p>
			</div>
			<!-- // 경품3 -->
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/html/et/spcialgift5/images/img_gift1000_04.gif" alt="서비스포인트 25,000P" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="04" title="서비스포인트 25,000P" />서비스포인트 <span class="ls0">25,000P</span> (<span class="ls0">100</span>명)</label></p>
		...
		<!-- // 1000만원 이상 -->
		<!-- 500만원 이상 -->
		<h2><img src="/html/et/spcialgift5/images/h2_gift_500.gif" alt="02. 목표금액이 300만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/html/et/spcialgift5/images/img_gift500_01.gif" alt="삼성 캠코더 68만 화소 SMX-F54BD" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="11" title="삼성 캠코더 68만 화소 SMX-F54BD" disabled="disabled"/>삼성 캠코더 68만 화소<br /> SMX-F54BD (<span class="ls0">5</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade11) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/html/et/spcialgift5/images/img_gift500_02.gif" alt="휴롬 천연 원액기 쥬서+녹즙 SJ-200" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="12" title="휴롬 천연 원액기 쥬서+녹즙 SJ-200" disabled="disabled"/>휴롬 천연 원액기  <br />쥬서+녹즙 SJ-200 (<span class="ls0">10</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='10' req_cnt='<%=String.valueOf(grade12) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/html/et/spcialgift5/images/img_gift500_03.gif" alt="캐시백 3만원" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="13" title="캐시백 3만원" disabled="disabled"/>캐시백 <span class="ls0">3</span>만원<br /> (<span class="ls0">30</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='30' req_cnt='<%=String.valueOf(grade13) %>' inputCss="" /></p>
			</div>
			<!-- // 경품3 -->
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/html/et/spcialgift5/images/img_gift500_04.gif" alt="서비스포인트15,000P" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="14" title="서비스포인트15,000P" disabled="disabled"/>서비스포인트 <span class="ls0">15,000P</span> (<span class="ls0">200</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='200' req_cnt='<%=String.valueOf(grade14) %>' inputCss="" /></p>
			</div>
			<!-- // 경품4 -->
		</div>
		<!-- // 500만원 이상 -->
		<!-- 300만원 이상 -->
		<h2><img src="/html/et/spcialgift5/images/h2_gift_300.gif" alt="02. 목표금액이 200만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/html/et/spcialgift5/images/img_gift300_01.gif" alt="쿠쿠 10인용 IH전기압력 밥솥CRP-HET108S" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="21" title="쿠쿠 10인용 IH전기압력 밥솥CRP-HET108S" disabled="disabled"/>쿠쿠 10인용 IH전기압력 <br /> 밥솥CRP-HET108S (<span class="ls0">10</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='10' req_cnt='<%=String.valueOf(grade21) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/html/et/spcialgift5/images/img_gift300_02.gif" alt="메디칼드림 백플러스2 두드림 마사지기 MD-561 블루" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="22" title="메디칼드림 백플러스2 두드림 마사지기 MD-561 블루" disabled="disabled"/><img src="/html/et/spcialgift5/images/100won_text.png" alt="메디칼드림 백플러스2 두드림 마사지기 MD-561 블루" style="width: 126px; height: 29px; padding-top: 3px;"/></label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='30' req_cnt='<%=String.valueOf(grade22) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/html/et/spcialgift5/images/img_gift300_03.gif" alt="캐시백 2만원" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="23" title="캐시백 2만원" disabled="disabled"/>캐시백 <span class="ls0">2</span>만원<br /> (<span class="ls0">80</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='80' req_cnt='<%=String.valueOf(grade23) %>' inputCss="" /></p>
			</div>
			<!-- // 경품3 -->
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/html/et/spcialgift5/images/img_gift300_04.gif" alt="서비스포인트 10,000 point" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="24" title="서비스포인트 10,000 point" disabled="disabled"/>서비스포인트 <span class="ls0">10,000P</span> (<span class="ls0">300</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='300' req_cnt='<%=String.valueOf(grade24) %>' inputCss="" /></p>
			</div>
			<!-- // 경품4 -->
		</div>
		<!-- // 300만원 이상 -->
		<!-- 100만원 이상 -->
		<h2><img src="/html/et/spcialgift5/images/h2_gift_100.gif" alt="04. 목표금액이 100만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/html/et/spcialgift5/images/img_gift100_01.gif" alt="알칼리온 고칼슘쌀 10KG" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="31" title="알칼리온 고칼슘쌀 10KG" disabled="disabled"/>알칼리온 고칼슘쌀<br />10KG (<span class="ls0">30</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='30' req_cnt='<%=String.valueOf(grade31) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/html/et/spcialgift5/images/img_gift100_02.gif" alt="밥도둑 3총사" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="32" title="밥도둑 3총사" disabled="disabled"/>밥도둑 3총사 <br /> (<span class="ls0">50</span>명)</p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='50' req_cnt='<%=String.valueOf(grade32) %>' inputCss="" /></</p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/html/et/spcialgift5/images/img_gift100_03.gif" alt="캐시백 1만원" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="33" title="캐시백 1만원" disabled="disabled"/>캐시백 <span class="ls0">1</span>만원<br /> (<span class="ls0">100</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='100' req_cnt='<%=String.valueOf(grade33) %>' inputCss="" /></p>
			</div>
			<!-- // 경품3 -->
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/html/et/spcialgift5/images/img_gift100_04.gif" alt="서비스포인트 5,000 point" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="34" title="서비스포인트 5,000 point" disabled="disabled"/>서비스포인트 <span class="ls0">5,000P</span><br />(<span class="ls0">400</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='400' req_cnt='<%=String.valueOf(grade34) %>' inputCss="" /></p>
			</div>
			<!-- // 경품4 -->
		</div>
		<!-- // 100만원 이상 -->
		<!-- 50만원 이상 -->
		<h2><img src="/html/et/spcialgift5/images/h2_gift_50.gif" alt="05. 목표금액이 50만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/html/et/spcialgift5/images/img_gift50_01.gif" alt="롯데시네마 ⓜGift카드 2인 관람권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="41" title="롯데시네마 ⓜGift카드 2인 관람권" disabled="disabled"/>롯데시네마<span class="ls0">ⓜGift</span> 카드<br /> <span class="ls0">2</span>인 관람권(<span class="ls0">80</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='80' req_cnt='<%=String.valueOf(grade41) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/html/et/spcialgift5/images/img_gift50_02.gif" alt="레터스 프롬 케언즈 다이어리" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="42" title="레터스 프롬 케언즈 다이어리" disabled="disabled"/>레터스 프롬 케언즈<br />다이어리 (<span class="ls0">200</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='200' req_cnt='<%=String.valueOf(grade42) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/html/et/spcialgift5/images/img_gift50_03.gif" alt="캐시백 5천원" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="43" title="캐시백 5천원" disabled="disabled"/>캐시백 <span class="ls0">5</span>천원 <br />(<span class="ls0">300</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='300' req_cnt='<%=String.valueOf(grade43) %>' inputCss="" /></p>
			</div>
			<!-- // 경품3 -->
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/html/et/spcialgift5/images/img_gift50_04.gif" alt="서비스포인트 3,000 point" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="44" title="서비스포인트 3,000 point" disabled="disabled"/>서비스포인트 <span class="ls0">3,000P</span><br />(<span class="ls0">500</span>명)</label></p>
...
<!-- // 수정 110217 -->
		<!-- // 경품선택 -->
		<!-- 배송지 주소 -->
		<h1><img src="/html/et/spcialgift5/images/h1_step03.gif" alt="STEP 03. 배송받으실 주소를 입력해주세요." /></h1>
		<table summary="배송받으실 주소를 입력하실 수 있습니다.">
			...
			<tbody>
				<tr>
					...
					<label><input type="text" name="home_zip_1" maxlength="3" class="txt zip" value="" title="우편번호 앞자리" onclick="searchZip(form1.home_zip_1, form1.home_zip_2, form1.home_zip_seq, form1.home_addr_area, form1.home_addr_dist);" /></label>&nbsp;-&nbsp;
					<label><input type="text" name="home_zip_2" maxlength="3" class="txt zip" value="" title="우편번호 뒷자리" onclick="searchZip(form1.home_zip_1, form1.home_zip_2, form1.home_zip_seq, form1.home_addr_area, form1.home_addr_dist);" /></label>
					...
					<img src="/html/et/spcialgift5/images/btn_add_search.gif" alt="우편번호검색" /></a><br />
						<span class="detail"><label><input name="home_addr_area" type="text" class="txt home_addr_area" readonly="readonly" value="" title="주소" onclick="searchZip(form1.home_zip_1, form1.home_zip_2, form1.home_zip_seq, form1.home_addr_area, form1.home_addr_dist);"/></label>
						<label><input name="home_addr_dist" type="text" class="txt home_addr_dist" readonly="readonly" value="" title="주소" maxlength="35" onclick="searchZip(form1.home_zip_1, form1.home_zip_2, form1.home_zip_seq, form1.home_addr_area, form1.home_addr_dist);"/></label>
						</p>							
					</td>
		...
		<!-- // 배송지 주소 -->
		<!-- 경품배송 동의안내 -->
		<h1><img src="/html/et/spcialgift5/images/h1_step04.gif" alt="STEP 04. 경품 배송 동의 안내입니다." /></h1>
		...
		<img src="/html/et/spcialgift5/images/btn_app.gif" alt="응모하기" /></a></p>
		<p class="mt30"><img src="/html/et/spcialgift5/images/txt_giftspecial_event2.gif" alt="삼성카드 Gift Special 이벤트는 삼성카드를 이용하시는 회원님들께 감사의 마음을 담아 준비한 이벤트로, 정기적으로 회원님을 찾아가려 합니다. 의미있는 상품으로 회원님께 최고의 가치를 제공하려 항상 노력하겠습니다." /></p>
	</div>
	...
	<div id="id_layer" class="pop_l_position pop_l_wrap_alert" style="display:none;"> 
		...
		<p class="pop_tit"><img src="/html/et/spcialgift5/images/lay_tit_giftspecial.gif" alt="삼성카드 Gift Special" /></p>
		<p class="pop_tit2"><img src="/html/et/spcialgift5/images/lay_tit_autumn4.gif" alt="제 4탄 가을 이야기" /></p>
		<p class="pop_txt">회원님께서 목표금액을 달성 하시고 선택하신 경품도 받아가세요!</p>
			...
			<div class="pop_l_content2">
				...
				<p><strong>이용금액 안내</strong></p>
							...
							<p class="btnc mt20"><a href="#" onclick="document.getElementById('id_layer').style.display='none';closeLayerPopup();"><img src="/html/et/spcialgift5/images/btn_s_confirm.gif" alt="확인" /></a></p>
						</div>
					</div>
				</div>				
