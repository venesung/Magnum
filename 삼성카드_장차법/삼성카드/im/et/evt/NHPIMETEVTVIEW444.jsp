...
<title>송년모임 100%지원 프로젝트 - 삼성카드</title>
<%
...
<img src="/images/et/yearend_201111.jpg" width="728" height="850" border="0" usemap="#Map" alt="송년모임 100% 지원 프로젝트!" />
<map name="Map" id="Map">
    <area shape="rect" coords="275,598,431,658" href="#" onclick="go_start();" alt="응모하기" />
</map>
