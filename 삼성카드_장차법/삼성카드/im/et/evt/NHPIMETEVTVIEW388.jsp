...
<title>삼성카드 혜택을 즐겨 보세요! - 삼성카드</title>
<%
...
<img src="/images/event/HPevent_110329.jpg" width="728" height="890" border="0" usemap="#Map" alt="삼성카드 혜택을 즐겨 보세요!" />
<map name="Map" id="Map">
  <area shape="rect" coords="305,748,429,785" href="javascript:go_start();" alt="이벤트 응모하기" />
</map>
</body>
