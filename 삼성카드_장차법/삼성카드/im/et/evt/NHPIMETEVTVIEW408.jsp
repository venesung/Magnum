...
.giftevent_top	{width:728px; height:20px; background:url('/images/et/giftspecial/bg_tmp_top.gif') no-repeat}
.giftevent_btm	{width:728px; height:20px; background:url('/images/et/giftspecial//bg_tmp_btm.gif') no-repeat}
.giftevent	{height:100%; background:url('/images/et/giftspecial/bg_tmp_mid.gif') repeat-y; padding:0 49px}
...
.gift_bg	{position:relative; width:630px; height:181px; background:url('/images/et/giftspecial/bg_event_gift.jpg') no-repeat; margin-bottom:10px}
...
.agree_s_info {width:570px; height:40px; overflow:hidden; padding:5px 8px; overflow-y:none}
...
.box_white	 {position:relative; background:white url('/images/et/giftspecial/box_white.gif') no-repeat}
...
.box_white_btm	 {padding:10px; background:url('/images/et/giftspecial/box_white.gif') no-repeat right bottom}
...
.pop_l_position	{position:absolute; left:0%; _left:170px; top:233px; _top:333px; z-index:600} /* position:fixed; _ */

.pop_l_wrap	{position:relative; width:464px; height:294px; border:3px solid #245FB3; background:white; z-index:511}
.pop_l_wrap	.img_l_pop	 {position:absolute; background:url('/images/et/giftspecial/pop_bg_layer.gif') no-repeat; overflow:hidden; z-index:513}
...
<script language="javascript" type="text/javascript">
		...
		function pop201102() {
			window.open('/html/et/spcialgift/event.html','pop201105','menubar=0,resizable=0,scrollbars=0,width=710,height=610,left=0,top=0');
		}
function applyEvent() {
		var chkCheckbox = "N";
...
<%}%>
		...
		document.form1.action="/hp/im/et/evt.do?method=applySpecialGiftEvent";
...
<div id="special_gift">
	<p><img src="/images/et/giftspecial/event_gift_special.jpg" alt="GIFT Special 제2탄 상품권 콜렉션편" usemap="#gift" /></p>
</div>

<map name="gift" id="gift">
 <area shape="rect" coords="309,839,410,871" href="#" onclick="parent.eventLogin('11612');" alt="로그인" />
</map>
...
<div id="special_gift">
	...
	<p><img src="/images/et/giftspecial/event_gift_special_top.jpg" alt="Gift Special 삼품권 콜렉션 편" /></p>
	<div class="giftevent">
		<p class="al_center mb10"><a id="NHPIMETEVTVIEW408_L01" href="#" onclick="document.getElementById('id_layer').style.display='block';fnSetReturnFocusId('NHPIMETEVTVIEW408_L01','id_layer');">
		<img src="/images/et/giftspecial/btn_payview.gif" alt="현재까지 이용금액 보기" /></a></p>

		<!-- 목표금액 설정 -->
		<h1><img src="/images/et/giftspecial/h1_step01.gif" alt="STEP 01. 목표금액을 설정해주세요." />지난 2개월간 고객님의 평균 실적은 <strong class="t_point_org t_no"><%=StringUtil.replace(approveSum,".5","") %></strong>원 입니다.</h1>
		<table summary="행사기간 동안 목표 이용 금액을 설정해주세요.">
        	<caption>목표금액을 설정</caption>
...
<!-- // 수정 110214 -->
		...
		<!-- // 목표금액 설정 -->
		<!-- 경품선택 -->
		<h1><img src="/images/et/giftspecial/h1_step02.gif" alt="STEP 02. 경품을 선택 헤주세요." />
		<a href="#" onclick="pop201102();"><img src="/images/et/giftspecial/btn_countryview.gif" alt="상품권 자세히 보기" /></a></h1>
<!-- 수정 110217 -->
		<!-- 1000만원 이상 -->
		<h2 class="gift1"><img src="/images/et/giftspecial/h2_gift_1000.gif" alt="01. 목표금액이 500만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/images/et/giftspecial/img_gift1000_01.gif" alt="신세계 상품권 30만원권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="01" title="신세계 상품권 30만원권 (5명)" />신세계 상품권<br /> <span class="ls0">30</span>만원권 (<span class="ls0">5</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade01) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/images/et/giftspecial/img_gift1000_02.gif" alt="삼성 상품권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="02" title="삼성 상품권 (10명) 15만원권" />삼성 상품권<br /> <span class="ls0">15</span>만원권 (<span class="ls0">10</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='10' req_cnt='<%=String.valueOf(grade02) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/images/et/giftspecial/img_gift1000_03.gif" alt="삼성 기프트카드" /></p>
			...
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/images/et/giftspecial/img_gift1000_04.gif" alt="서비스포인트" /></p>
		...
		<!-- // 1000만원 이상 -->
		<!-- 500만원 이상 -->
		<h2><img src="/images/et/giftspecial/h2_gift_500.gif" alt="02. 목표금액이 300만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/images/et/giftspecial/img_gift500_01.gif" alt="해피머니 외식상품권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="11" title="해피머니 외식상품권 (5명) 15만원권" disabled="disabled"/>해피머니 외식상품권<br /> <span class="ls0">15</span>만원권 (<span class="ls0">5</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade11) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/images/et/giftspecial/img_gift500_02.gif" alt="캐리비안베이 2인 이용권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="12" title="캐리비안베이 2인 이용권 (20명)" disabled="disabled"/>캐리비안베이<br /> <span class="ls0">2</span>인 이용권 (<span class="ls0">20</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='20' req_cnt='<%=String.valueOf(grade12) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/images/et/giftspecial/img_gift500_03.gif" alt="캐시백 3만원" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="13" title="캐시백 3만원 (100명)" disabled="disabled"/>캐시백 <span class="ls0">3</span>만원<br /> (<span class="ls0">100</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='100' req_cnt='<%=String.valueOf(grade13) %>' inputCss="" /></p>
			</div>
			<!-- // 경품3 -->
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/images/et/giftspecial/img_gift500_04.gif" alt="서비스포인트" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="14" title="서비스포인트 (200명) 15,000 point" disabled="disabled"/>서비스포인트<br /> <span class="ls0">15,000P</span> (<span class="ls0">200</span>명)</label></p>
		...
		<!-- // 500만원 이상 -->
		<!-- 300만원 이상 -->
		<h2><img src="/images/et/giftspecial/h2_gift_300.gif" alt="02. 목표금액이 200만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/images/et/giftspecial/img_gift300_01.gif" alt="CJ 상품권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="21" title="CJ 상품권 (5명) 10만원권" disabled="disabled"/><span class="ls0">CJ</span> 상품권 <span class="ls0">10</span>만원권<br /> (<span class="ls0">5</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade21) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/images/et/giftspecial/img_gift300_02.gif" alt="에버랜드 2인 이용권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="22" title="에버랜드 2인 이용권 (30명)" disabled="disabled"/>에버랜드 <span class="ls0">2</span>인 이용권<br /> (<span class="ls0">30</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='30' req_cnt='<%=String.valueOf(grade22) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/images/et/giftspecial/img_gift300_03.gif" alt="캐시백 2만원" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="23" title="캐시백 2만원 (150명)" disabled="disabled"/>캐시백 <span class="ls0">2</span>만원<br /> (<span class="ls0">150</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='150' req_cnt='<%=String.valueOf(grade23) %>' inputCss="" /></p>
			</div>
			<!-- // 경품3 -->
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/images/et/giftspecial/img_gift300_04.gif" alt="서비스포인트" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="24" title="서비스포인트 (300명) 10,000 point" disabled="disabled"/>서비스포인트<br /> <span class="ls0">10,000P</span> (<span class="ls0">300</span>명)</label></p>
		...
		<!-- // 300만원 이상 -->
		<!-- 100만원 이상 -->
		<h2><img src="/images/et/giftspecial/h2_gift_100.gif" alt="04. 목표금액이 100만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/images/et/giftspecial/img_gift100_01.gif" alt="S-OIL 상품권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="31" title="S-OIL 상품권 (5명) 5만원권" disabled="disabled"/><span class="ls0">S-OIL</span> 상품권 <span class="ls0">5</span>만원권<br /> (<span class="ls0">5</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade31) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/images/et/giftspecial/img_gift100_02.gif" alt="피자헛 상품권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="32" title="피자헛 상품권 (200명) 3만원권" disabled="disabled"/>피자헛 상품권<br /> <span class="ls0">3</span>만원권 (<span class="ls0">200</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='200' req_cnt='<%=String.valueOf(grade32) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/images/et/giftspecial/img_gift100_03.gif" alt="캐시백 1만원" /></p>
				...
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='250' req_cnt='<%=String.valueOf(grade33) %>' inputCss="" /></p>
			</div>
			<!-- // 경품3 -->
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/images/et/giftspecial/img_gift100_04.gif" alt="서비스포인트" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="34" title="서비스포인트 (400명) 5,000 point" disabled="disabled"/>서비스포인트<br /> <span class="ls0">5,000P</span> (<span class="ls0">400</span>명)</label></p>
		...
		<!-- // 100만원 이상 -->
		<!-- 50만원 이상 -->
		<h2><img src="/images/et/giftspecial/h2_gift_50.gif" alt="05. 목표금액이 50만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/images/et/giftspecial/img_gift50_01.gif" alt="아웃백 모바일기프트카드" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="41" title="아웃백 모바일기프트카드 3만원권 (100명)" disabled="disabled"/>아웃백 <span class="ls0">ⓜGift</span> 카드<br /> <span class="ls0">3</span>만원권(<span class="ls0">100</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='100' req_cnt='<%=String.valueOf(grade41) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/images/et/giftspecial/img_gift50_02.gif" alt="스타벅스 모바일기프트카드" /></p>
			...
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/images/et/giftspecial/img_gift50_03.gif" alt="캐시백 5천원" /></p>
			...
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/images/et/giftspecial/img_gift50_04.gif" alt="서비스포인트" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="44" title="서비스포인트 3,000 point (550명)" disabled="disabled"/>서비스포인트 <br /><span class="ls0">3,000P</span> (<span class="ls0">550</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='550' req_cnt='<%=String.valueOf(grade44) %>' inputCss="" /></p>
			</div>
			<!-- // 경품4 -->
		</div>
		<!-- // 50만원 이상 -->
<!-- // 수정 110217 -->
		<!-- // 경품선택 -->
		<!-- 배송지 주소 -->
		<h1><img src="/images/et/giftspecial/h1_step03.gif" alt="STEP 03. 배송받으실 주소를 입력해주세요." /></h1>
		<table summary="배송받으실 주소를 입력해주세요">
        	<caption>배송받을 주소 입력</caption>
			...
			<tbody>
				<tr>
					...
					<input type="text" name="home_zip_1" maxlength="3" class="txt zip" value="" title="우편번호 앞자리" onclick="searchZipMain(form1.home_zip_1, form1.home_zip_2, form1.home_zip_seq, form1.home_addr_area, form1.home_addr_dist, '<%=newjusoYn %>');" />&nbsp;-&nbsp;
					<input type="text" name="home_zip_2" maxlength="3" class="txt zip" value="" title="우편번호 뒷자리" onclick="searchZipMain(form1.home_zip_1, form1.home_zip_2, form1.home_zip_seq, form1.home_addr_area, form1.home_addr_dist, '<%=newjusoYn %>');" />
					...
					<img src="/images/et/giftspecial/btn_add_search.gif" alt="우편번호검색" /></a><br />
						<span class="detail"><input name="home_addr_area" type="text" class="txt home_addr_area" readonly="readonly" value="" title="주소" onclick="searchZipMain(form1.home_zip_1, form1.home_zip_2, form1.home_zip_seq, form1.home_addr_area, form1.home_addr_dist, '<%=newjusoYn %>');"/>
						<input name="home_addr_dist" type="text" class="txt home_addr_dist" readonly="readonly" value="" title="주소" maxlength="40" onclick="searchZipMain(form1.home_zip_1, form1.home_zip_2, form1.home_zip_seq, form1.home_addr_area, form1.home_addr_dist, '<%=newjusoYn %>');"/>
						</p>							
					</td>
		...
		<!-- // 배송지 주소 -->
		<!-- 경품배송 동의안내 -->
		<h1><img src="/images/et/giftspecial/h1_step04.gif" alt="STEP 04. 경품 배송 동의 안내입니다." /></h1>
...
<!-- 수정 110214 -->
			<p class="btnl t_desc04"><span class="t_default">※</span> 제휴배송업체 : STM NET</p>
<!-- // 수정 110214 -->
			<div class="btnr">
		...
		<img src="/images/et/giftspecial/btn_app.gif" alt="응모하기/수정하기" /></a></p>
		<!-- 삼성카드 special event란? -->
		<p class="mt30"><img src="/images/et/giftspecial/txt_giftspecial_event.gif" alt="삼성카드 Gift Special 이벤트란 삼성카드를 이용하는 회원님들께 감사의 마음을 담아 준비한 기프트 이벤트로 정기적으로 회원님을 찾아가려 합니다. 의미있는 상품으로 회원님께 최고의 가치를 제공하려 항상 노력하겠습니다." /></p>
		<!-- // 삼성카드 special event란? -->
	</div>
	...
	<div id="id_layer" class="pop_l_position pop_l_wrap_alert" style="display:none;"> 
		...
		<p class="pop_tit"><img src="/images/et/giftspecial/lay_tit_giftspecial.gif" alt="삼성카드 Gift Special" /></p>
		<p class="pop_tit2"><img src="/images/et/giftspecial/lay_tit_t01.gif" alt="제 2탄 상품권 콜렉션편 " /></p>
		<p class="pop_txt">회원님께서 목표금액을 달성 하시고 선택하신 경품도 받아가세요!</p>
			...
			<div class="pop_l_content2">
				...
				<p><strong>이용금액 안내</strong></p>
								<table class="dtable01 mt10" summary="목표금액, 현재까지 도달 금액, 목표달성까지 등 목표금액에 관한 정보입니다.">
							...
							<p class="btnc mt20"><a href="#" onclick="document.getElementById('id_layer').style.display='none';closeLayerPopup();"><img src="/images/et/giftspecial/btn_s_confirm.gif" alt="확인" /></a></p>
						</div>
					</div>
				</div>				
