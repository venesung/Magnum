...
.giftevent_top	{width:728px; height:20px; background:url('/images/et/giftspecial3/bg_tmp_top.gif') no-repeat}
.giftevent_btm	{width:728px; height:20px; background:url('/images/et/giftspecial3/bg_tmp_btm.gif') no-repeat}
.giftevent	{height:100%; background:url('/images/et/giftspecial3/bg_tmp_mid.gif') repeat-y; padding:0 49px}
...
.gift_bg	{position:relative; width:630px; height:181px; background:url('/images/et/giftspecial3/bg_event_gift.jpg') no-repeat; margin-bottom:10px}
...
.box_white	 {position:relative; background:white url('/images/et/giftspecial3/box_white.gif') no-repeat}
...
.box_white_btm	 {padding:10px; background:url('/images/et/giftspecial3/box_white.gif') no-repeat right bottom}
...
.pop_l_wrap	.img_l_pop	 {position:absolute; background:url('/images/et/giftspecial3/pop_bg_layer.gif') no-repeat; overflow:hidden; z-index:513}
...
<script language="javascript" type="text/javascript">
		...
		function pop201102() {
			window.open('/html/et/spcialgift3/event.html','pop201108','menubar=0,resizable=0,scrollbars=0,width=710,height=610,left=0,top=0');
		}
function applyEvent() {
		var chkCheckbox = "N";
...
<%}%>
		...
		document.form1.action="/hp/im/et/evt.do?method=applySpecialGiftEvent3";
...
<div id="special_gift">
	<p><img src="/images/et/giftspecial3/event_gift_special03.jpg" alt="GIFT Special 제3탄 한가위 선물" usemap="#gift" /></p>
</div>

<map name="gift" id="gift">
 <area shape="rect" coords="309,768,409,798" href="#" onClick="parent.eventLogin('11794');" alt="로그인" />
</map>
...
<div id="special_gift">
	...
	<p><img src="/images/et/giftspecial3/event_gift_special_top3.jpg" alt="Gift Special 한가위 선물" /></p>
	<div class="giftevent">
		<p class="al_center mb10"><a id="NHPIMETEVTVIEW424_L01" href="#" onClick="document.getElementById('id_layer').style.display='block';fnSetReturnFocusId('NHPIMETEVTVIEW424_L01','id_layer');">
		<img src="/images/et/giftspecial3/btn_payview.gif" alt="현재까지 이용금액 보기" /></a></p>

		<!-- 목표금액 설정 -->
		<h1><img src="/images/et/giftspecial3/h1_step01.gif" alt="STEP 01. 목표금액을 설정해주세요." />지난 2개월간 고객님의 평균 실적은 <strong class="t_point_org t_no"><%=StringUtil.replace(approveSum,".5","") %></strong>원 입니다.</h1>
		<table summary="행사기간 동안 목표 이용 금액을 설정하실 수 있습니다.">
        <caption>목표 이용 금액 설정</caption>
			...
			<tbody>
				<tr>
					...
					<td>
<!-- 수정 110214 -->
						<select name="objectAmount" style="width:200px" onChange="chgSel();" title="행사기간 동안 목표 이용 금액">
...
<!-- // 수정 110214 -->
		...
		<!-- // 목표금액 설정 -->
		<!-- 경품선택 -->
		<h1><img src="/images/et/giftspecial3/h1_step02.gif" alt="STEP 02. 경품을 선택 헤주세요." />
		<a href="#" onClick="pop201102();" title="새창"><img src="/images/et/giftspecial3/btn_countryview2.gif" alt="경품 자세히 보기" /></a></h1>
<!-- 수정 110217 -->
		<!-- 1000만원 이상 -->
		<h2 class="gift1"><img src="/images/et/giftspecial3/h2_gift_1000.gif" alt="01. 목표금액이 500만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/images/et/giftspecial3/img_gift1000_01.gif" alt="삼성 LED TV" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="01" title="삼성 LED TV 46' (1명)" />삼성 LED TV 46'<br /> (<span class="ls0">1</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade01) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/images/et/giftspecial3/img_gift1000_02.gif" alt="올림푸스 디지털카메라 패키지" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="02" title="올림푸스 디지털카메라 패키지(10명)" />올림푸스 디지털카메라<br /> 패키지 (<span class="ls0">10</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='10' req_cnt='<%=String.valueOf(grade02) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/images/et/giftspecial3/img_gift1000_03.gif" alt="삼성 기프트카" /></p>
			...
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/images/et/giftspecial3/img_gift1000_04.gif" alt="서비스포인트" /></p>
		...
		<!-- // 1000만원 이상 -->
		<!-- 500만원 이상 -->
		<h2><img src="/images/et/giftspecial3/h2_gift_500.gif" alt="02. 목표금액이 300만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/images/et/giftspecial3/img_gift500_01.gif" alt="네스프레소 에스프레소머신" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="11" title="네스프레소 에스프레소머신 (5명)" disabled="disabled"/>네스프레소 에스프레소<br /> 머신 (<span class="ls0">5</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade11) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/images/et/giftspecial3/img_gift500_02.gif" alt="코베아 캠핑용품 패키지" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="12" title="코베아 캠핑용품 패키지 (20명)" disabled="disabled"/>코베아 캠핑용품 <br /> 패키지 (<span class="ls0">20</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='20' req_cnt='<%=String.valueOf(grade12) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/images/et/giftspecial3/img_gift500_03.gif" alt="캐시백 3만원" /></p>
			...
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/images/et/giftspecial3/img_gift500_04.gif" alt="서비스포인트" /></p>
		...
		<!-- // 500만원 이상 -->
		<!-- 300만원 이상 -->
		<h2><img src="/images/et/giftspecial3/h2_gift_300.gif" alt="02. 목표금액이 200만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/images/et/giftspecial3/img_gift300_01.gif" alt="헹켈 5스타 5종 칼블럭 세트" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="21" title="헹켈 5스타 5종 칼블럭 세트(5명)" disabled="disabled"/>헹켈 5스타 5종 칼블럭 <br /> 세트 (<span class="ls0">5</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade21) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/images/et/giftspecial3/img_gift300_02.gif" alt="에버랜드 2인 이용권" /></p>
			...
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/images/et/giftspecial3/img_gift300_03.gif" alt="캐시백 2만원" /></p>
			...
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/images/et/giftspecial3/img_gift300_04.gif" alt="서비스포인트" /></p>
		...
		<!-- // 300만원 이상 -->
		<!-- 100만원 이상 -->
		<h2><img src="/images/et/giftspecial3/h2_gift_100.gif" alt="04. 목표금액이 100만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/images/et/giftspecial3/img_gift100_01.gif" alt="정관장 이체 홍삼 세트" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="31" title="정관장 이체 홍삼 세트 (5명)" disabled="disabled"/>정관장 이체 홍삼 세트 <br /> (<span class="ls0">5</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade31) %>' inputCss="" /></p>
			</div>
			<!-- // 경품1 -->
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/images/et/giftspecial3/img_gift100_02.gif" alt="피자헛 상품권" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="32" title="피자헛 상품권 (200명) 3만원권" disabled="disabled"/>독일 기펠 키친툴 7종 <br />세트 (<span class="ls0">200</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='200' req_cnt='<%=String.valueOf(grade32) %>' inputCss="" /></p>
			</div>
			<!-- // 경품2 -->
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/images/et/giftspecial3/img_gift100_03.gif" alt="캐시백 1만원" /></p>
			...
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/images/et/giftspecial3/img_gift100_04.gif" alt="서비스포인트" /></p>
		...
		<!-- // 100만원 이상 -->
		<!-- 50만원 이상 -->
		<h2><img src="/images/et/giftspecial3/h2_gift_50.gif" alt="05. 목표금액이 50만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 경품1 -->
			<div class="gift1">
				<p><img src="/images/et/giftspecial3/img_gift50_01.gif" alt="롯데시네마 ⓜGift카드 2인 관람권" /></p>
			...
			<!-- 경품2 -->
			<div class="gift2">
				<p><img src="/images/et/giftspecial3/img_gift50_02.gif" alt="스타벅스 모바일기프트카드 1만원권" /></p>
			...
			<!-- 경품3 -->
			<div class="gift3">
				<p><img src="/images/et/giftspecial3/img_gift50_03.gif" alt="캐시백 5천원" /></p>
			...
			<!-- 경품4 -->
			<div class="gift4">
				<p><img src="/images/et/giftspecial3/img_gift50_04.gif" alt="서비스포인트" /></p>
...
<!-- // 수정 110217 -->
		<!-- // 경품선택 -->
		<!-- 배송지 주소 -->
		<h1><img src="/images/et/giftspecial3/h1_step03.gif" alt="STEP 03. 배송받으실 주소를 입력해주세요." /></h1>
		<table summary="배송받으실 주소를 입력하실 수 있습니다.">
			...
			<tbody>
				<tr>
					...
					<img src="/images/et/giftspecial3/btn_add_search.gif" alt="우편번호검색" /></a><br />
						<span class="detail"><input name="home_addr_area" type="text" class="txt home_addr_area" readonly value="" title="주소" onClick="searchZip(form1.home_zip_1, form1.home_zip_2, form1.home_zip_seq, form1.home_addr_area, form1.home_addr_dist);"/>
						<input name="home_addr_dist" type="text" class="txt home_addr_dist" readonly value="" title="주소" maxlength="35" onClick="searchZip(form1.home_zip_1, form1.home_zip_2, form1.home_zip_seq, form1.home_addr_area, form1.home_addr_dist);"/>
						</p>							
					</td>
		...
		<!-- // 배송지 주소 -->
		<!-- 경품배송 동의안내 -->
		<h1><img src="/images/et/giftspecial3/h1_step04.gif" alt="STEP 04. 경품 배송 동의 안내입니다." /></h1>
...
<!-- // 수정 110214 -->
		...
		<img src="/images/et/giftspecial3/btn_app.gif" alt="응모하기/수정하기" /></a></p>
		<!-- 삼성카드 special event란? -->
		<p class="mt30"><img src="/images/et/giftspecial3/txt_giftspecial_event.gif" alt="삼성카드 Gift Special 이벤트는 삼성카드를 이요하는 회원님들께 감사의 마음을 담아 준비한 기프트 이벤트로 정기적으로 회원님을 찾아가려 합니다. 의미있는 상품으로 회원님께 최고의 가치를 제공하려 항상 노력하겠습니다." /></p>
		<!-- // 삼성카드 special event란? -->
	</div>
	...
	<div id="id_layer" class="pop_l_position pop_l_wrap_alert" style="display:none;"> 
		...
		<p class="pop_tit"><img src="/images/et/giftspecial3/lay_tit_giftspecial.gif" alt="삼성카드 Gift Special" /></p>
		<p class="pop_tit2"><img src="/images/et/giftspecial3/lay_tit_t01.gif" alt="제 3탄 한가위 선물 " /></p>
		<p class="pop_txt">회원님께서 목표금액을 달성 하시고 선택하신 경품도 받아가세요!</p>
			...
			<div class="pop_l_content2">
				...
				<p><strong>이용금액 안내</strong></p>
								<table class="dtable01 mt10" summary="목표금액, 현재까지 도달 금액, 목표달성까지 등 경품을 받을 수 있는 목표금액 정보를 제공합니다.">
							...
							<p class="btnc mt20"><a href="#" onClick="document.getElementById('id_layer').style.display='none';closeLayerPopup();"><img src="/images/et/giftspecial3/btn_s_confirm.gif" alt="확인" /></a></p>
						</div>
					</div>
				</div>				
