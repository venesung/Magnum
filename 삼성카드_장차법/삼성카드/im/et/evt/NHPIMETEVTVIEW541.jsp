...
<title>한국 뮤지컬의 신화! 뮤지컬 &lt;영웅&gt; 무료 초대 이벤트</title>
<%
...
#lay_1{display:none; position:absolute; z-index:2; left:131px; top:700px; }
...
<script language="javascript" type="text/javascript">
	...
	function applyEvent(gubun) {
		...
		window.open('','win','width=710px, height=611px, menubar=no, toolbar=no, location=no, status=no, scrollbars=yes');
		frm.target = 'win';
		frm.action = "/hp/im/et/evt002.do?method=getHeroPop201209";	
		frm.submit();
		//ScardSubmit(frm);
	}
...
<img src="/images/et/hero201209/event_musical.jpg" alt="한국 뮤지컬의 신화! 뮤지컬 영웅 무료 초대 이벤트" border="0" usemap="#musical" />

	<div class="hidden">
		<p>한국 뮤지컬의 신화!</p>
		<h1>뮤지컬 &lt;영웅&gt; 무료 초대 이벤트</h1>
		<p>국내 뮤지컬의 자존심! 브로드웨이까지 사로잡은 감동의 뮤지컬 관람의 기회! 지금 바로 응모하세요</p>
		
		<dl>
			<dt>응모기간</dt>
			<dd>2012년 9월 21일(금) ~ 10월 14일(일)</dd>
			<dt>행사대상</dt>
			<dd>응모기간 중 삼성카드로 일시불 및 할부 70만원 이상 이용회원</dd>
			<dt>행사내용</dt>
			<dd>이벤트 응모회원 중 추첨을 통해 115명에게 뮤지컬 영웅 티켓 2매(영웅석)를 드립니다</dd>
			<dt>공연장소</dt>
			<dd>블루스퀘어 삼성전자 홀</dd>
			<dt>당첨자 발표</dt>
			<dd>2012년10월 16일(화)</dd>
		</dl>
		
        <p><a href="#none" onclick="go_starta();return false;">응모하기</a></p>
		<p>
			<a href="http://bluesquare.kr/Goods/PerformanceDetail.asp?PlayNo=38774" >공연 자세히 보기</a>
            <a href="#none" onclick="openlayera();return false;">내가 응모한 내역 확인하기</a>
		</p>
		
		<dl>
			<dt>티켓발송</dt>
			<dd>2012년 10월 18일(목)</dd>
			<dt>티켓수령방법</dt>
			<dd>이벤트 당첨회원에게 10월 16일 당첨 안내가 핸드폰 문자 메세지로 발송되며 티켓은 삼성카드에 등록된 회원님의 청구지 주소로 개별 배송됩니다.
				핸드폰번호 및 주소가 바뀐 회원님께서는 올바른 번호로 수정하셔야 티켓을 문제없이 받으실 수 있습니다. 
                <a href="#none" onclick="parent.goTabPage('NHPIMMHUFM001M001');return false;">핸드폰 번호 및 청구지 주소 수정하기</a>
			</dd>
		</dl>
		
		<ul>
			<li>- 1인 1개 날짜의 공연만 응모 가능하며 응모기간 내에 변경 가능합니다.</li>
...
<area shape="rect" coords="227,972,335,992" href="http://bluesquare.kr/Goods/PerformanceDetail.asp?PlayNo=38774" target="_blank" title="새창" alt="공연자세히 보기" />
<area shape="rect" coords="347,972,498,994" href="javascript:openlayera();"  alt="나의응모내역확인하기" />
<area shape="rect" coords="287,925,440,965" href="javascript:go_starta();" alt="이벤트 응모하기" />
<area shape="rect" coords="289,1162,485,1182" href="javascript:parent.goTabPage('NHPIMMHUFM001M001');" alt="핸드폰번호 및 청구지주소 수정하기" />
...
<!-- 레이어팝업-최초응모시 -->
	<div id="lay_1" class="pop_l_position pop_l_wrap_mix" >
		<div class="pop_l_wrap" style="height:200px;"><p class="img_l_pop flag_tl">&nbsp;</p><p class="img_l_pop flag_tr">&nbsp;</p><p class="img_l_pop flag_bl">&nbsp;</p><p class="img_l_pop flag_br">&nbsp;</p><input type="button" class="img_l_pop btn_close btn_input" onclick="this.parentNode.parentNode.style.display='none'; show_select();" value="레이어닫기" title="공연일시 레이어 닫기" />
			<p class="pop_tit" style="text-align:left;"><img src="/images/et/hero201209/layer_tit_1.png" alt="회원님께서 응모하신 공연일시입니다." /></p>
				<div class="pop_l_content">
					<div class="pop_l_alert" style="">
					<p class="pop_sub_desc"><%=user_name %> 회원님께서 응모하신 공연일시는 아래와 같습니다.</p>
					<table summary="공연명, 공연일시 등 응모하신 공연정보를 확인하실 수 있습니다." class="  dtable02"> 
