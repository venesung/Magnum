...
<p><img src="/images/event/asiana_event_110412.jpg" alt="새봄맞이 이벤트" usemap="#asiana" /></p>
<map name="asiana" id="asiana">
  <area shape="circle" coords="596,809,51" href="javascript:go_start();" alt="이벤트 응모하기" />
</map>
</body>
