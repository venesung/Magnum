...
<title>삼성석유화학가족의 Happy Donation! Vol.2 - 삼성카드</title>
<%
...
<img src="/images/et/donation201204/event_oil.jpg" alt="삼성석유화학가족의 Happy Donation! Vol.2" border="0" usemap="#donation" />

<div class="hidden">
	<p>삼성카드가 삼성석유화학의 창립기념일을 진심으로 축하드립니다.</p>
	<h1>삼성석유화학 가족의 Happy Donation! Vol.2</h1>
	
	<p>삼성석유화학의 38주년 창립기념일을 맞이하여, 삼성카드가 함께하는 이벤트를 준비하였습니다. 가족의 눈물을 희망으로 바꾸는 작은거인 서연이를 위한 Happy Donation! 4월 한 달 동안 후원에 동참하시는 삼성석유화학 임직원께서 사용하시는 삼성카드 이용금액의 0.1%를 모아 급성림프구성백혈병으로 항암치료 중인 서연이를 후원합니다. 후원 비용은 삼성카드에서 전액부담합니다. </p>
    <p><a href="#none" onclick="go_start();return false;"  >후원하기</a></p>
	
	
	<p>삼성석유화학 happy donation 후원아동</p>
    ...
    <p><a href="#none" onclick="go_start();return false;">후원하기</a></p>
	<ul>
		<li>- 기부금액은 후원에 참여하신 삼성석유화학 임직원이 2012년 4월 한 달간 사용하신 삼성카드 일시불+할부 이용금액의 0.1%입니다.</li>
		<li>- 삼성석유화학 임직원이 모아주신 기부금은 5월에 소아암협회를 통해 서연이에게 전달될 예정입니다.</li>
	</ul>
