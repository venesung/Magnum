...
<title>삼성에버랜드 가족의 Happy Donation! 2번째 이벤트 - 삼성카드</title>
<%
...
<img src="/images/et/donation201203/event_donation_everland.jpg" alt="삼성에버랜드가족의 Happy Donation! Vol.2" border="0" usemap="#donation" />


	<div class="hidden">
	<h1>삼성에버랜드 가족의 happy donation vol.02</h1>
	<p>삼성에버랜드 49주년 창립기념일을맞이하여, 삼성카드가 함께하는 이벤트를 준비하였습니다. 2011년 뇌종양을 앓던 찬식이에 이어, 올해에는 대규를 위한 happy donation! 3월 한달동안 후원에 동참하시는 삼성에버랜드 임직원께서 사용하시는 삼성카드 이용금액의 0.1%를 모아 버킷림프종으로 항암치료 중인 대규를 후원합니다. 후원비용은 삼성카드에서 전액 부담합니다.</p>
    <p><a href="#none" onclick="go_start();return false;" title="후원하러 바로가기">후원하러가기</a></p>
	
	<p>삼성에버랜드 happy donation  후원 아동</p>
	...
	<p>삼성에버랜드 가족 여러분 대규와 가족들이 힘든 시간을 잘 보낼 수 있도록 힘을 모아주세요!</p>
    <p><a href="#none" title="후원하러 가기" onclick="go_start();return false;">후원하러 가기</a></p>

	<ul>
		<li>- 기부금액은 후원에 참여하신 삼성에버랜드 임직원이 2012년 3월 한 달간 사용하신 삼성카드 일시불+할부 이용금액의 0.1% 입니다.</li>
