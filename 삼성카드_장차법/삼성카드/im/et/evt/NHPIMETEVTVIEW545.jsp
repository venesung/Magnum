...
<head>
<title>이번 가을, 삼성카드에 빠져보자! GIFT Special - 삼성카드</title>
<style type="text/css">
...
.giftevent_btm	{width:728px; height:65px; background:url('/html/et/spcialgift10/images/bg_tmp_btm.gif') no-repeat}
.giftevent	{height:100%; background:url('/html/et/spcialgift10/images/bg_tmp_mid.gif') repeat-y; padding:0 49px}
...
.gift_bg	{position:relative; width:630px; height:205px; background:url('/html/et/spcialgift10/images/bg_event_gift.jpg') no-repeat; margin-bottom:10px}
...
.box_white	 {position:relative; background: url('/html/et/spcialgift10/images/box_white.gif') no-repeat}
...
.box_white_btm	 {padding:10px; background:url('/html/et/spcialgift10/images/box_white.gif') no-repeat right bottom}
...
<script type="text/javascript" language="javascript">
	...
	function pop201202() {
		window.open('/html/et/spcialgift10/event.html','pop201210','menubar=0,resizable=0,scrollbars=0,width=710,height=610,left=0,top=0');
	}
	function applyEvent() {
		var chkCheckbox = "N";
...
<%}%>
		...
		document.form1.action="/hp/im/et/evt.do?method=applySpecialGiftEvent10";
...
<div id="special_gift">
	...
	<p><img src="/html/et/spcialgift10/images/event_gift_special_10.jpg" alt="이번 가을, 삼성카드에 빠져보자! GIFT Special" />
	
		<div class="hidden">
			<h1>이번 가을 삼성카드에 빠져보자! Gift Special</h1>
			<p>단풍과 함께 성큼 다가온 가을 삼성카드가 따뜻한 감성으로 회원님을 위해 다양한 선물을 마련했습니다. 이번 가을 삼성카드와 사랑에 빠져 보는 것은 어떨까요?</p>
			
			<dl>
				<dt>행사기간</dt>
				<dd>2012년 10월 2일(화) ~ 10월 31일(수)</dd>
				<dt>행사내용</dt>
				<dd>회원님께서 직접 일시불과 할부 이용금액을 합한 목표금액을 선택하시고 행사기간 동안 정해진 목표금액 이상 이용 시 추첨을 통해 경품 증정
					<p>- 목표금액은 2012년 7,8월 일시불과 할부 이용금액을 합한 월평균 이용금액보다 많은 금액으로만 응모하실 수 있습니다.</p>
				</dd>
				<dt>당첨자 발표</dt>
				<dd>2012년 11월 16일(금) 삼성카드 홈페이지 당첨자 발표란</dd>
				<dt>포인트 적립 및 경품배송일자</dt>
				<dd>2012년 11월 23일(금) 예정</dd>
				<dt>참여방법</dt>
				<dd>
					<ul>
						<li>step1 - 자신이 원하는 선물확인</li>
						<li>step2 - 목표금액 및 선물 선택</li>
						<li>step3 - 기간 내 목표금액 달성</li>
						<li>step4 - 추첨 후 당첨 회원님께 선물 제공</li>
					</ul>
				</dd>
			</dl>
	...
	<div class="giftevent">
		<p class="al_center mb10"><a id="NHPIMETEVTVIEW545_L01" href="#" onclick="eventPayView();fnSetReturnFocusId('NHPIMETEVTVIEW545_L01','id_layer');"><img src="/html/et/spcialgift10/images/btn_payview.gif" alt="현재까지 이용금액 보기" /></a></p>
		<!-- 목표금액 설정 -->
		<h1><img src="/html/et/spcialgift10/images/h1_step01.gif" alt="STEP 01. 목표금액을 설정해주세요." />지난 2개월동안 회원님의 월평균 이용금액은 <strong class="t_point_org t_no"><%=StringUtil.replace(approveSum,".5","") %></strong>원 입니다.</h1>
		...
		<caption>목표금액 설정</caption>
			...
			<tbody>
				<tr>
					...
					<td>
						<select name="objectAmount" style="width:200px" onchange="chgSel(this.value,1);" title="행사기간 동안 목표 이용 금액 선택">
		...
		<!-- // 목표금액 설정 -->
		<!-- 경품선택 -->
        <h1><img src="/html/et/spcialgift10/images/h1_step02.gif" alt="STEP 02. 경품을 선택 해주세요." />&nbsp;&nbsp;<a href="#" onclick="pop201202();" title="새창" ><img src="/html/et/spcialgift10/images/btn_countryview2.gif" alt="경품 자세히 보기" /></a></h1>
		<!-- 500만원 이상 -->
		<h2 class="gift1"><img src="/html/et/spcialgift10/images/h2_gift_500.gif" alt="01. 목표금액이 500만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<div class="gift1">
				<p><img src="/html/et/spcialgift10/images/img_gift_1001.gif" alt="삼성 지펠 아삭 스탠드형 " /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="01" <% if(item03.equals("01")){ %> checked="checked" <% } %> title="삼성 지펠 아삭 스탠드형" />삼성 지펠 아삭 스탠드형<br /><span class="ls0">김치냉장고 (327L)</span> <br /><span class="ls0">ZS33ETSAC1C</span> (<span class="ls0">1</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='1' req_cnt='<%=String.valueOf(grade01) %>' inputCss="" /></p>
			</div>
			<div class="gift2">
				<p><img src="/html/et/spcialgift10/images/img_gift_1002.gif" alt="휴롬 천연원액기" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="02" <% if(item03.equals("02")){ %> checked="checked" <% } %> title="휴롬 천연원액기" />휴롬 천연원액기<br /><span class="ls0">SJ-200B</span> (<span class="ls0">3</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='3' req_cnt='<%=String.valueOf(grade02) %>' inputCss="" /></p>
			</div>
			<div class="gift3">
				<p><img src="/html/et/spcialgift10/images/img_gift_1003.gif" alt="삼성 기프트카드  100,000원권" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="03" <% if(item03.equals("03")){ %> checked="checked" <% } %> title="삼성 기프트카드 100,000원권 " />삼성 기프트카드<br /><span class="ls0">100,000</span>원권 (<span class="ls0">7</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='7' req_cnt='<%=String.valueOf(grade03) %>' inputCss="" /></p>
			</div>
			<div class="gift4">
				<p><img src="/html/et/spcialgift10/images/img_gift_1004.gif" alt="서비스포인트 30,000P" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="04" <% if(item03.equals("04")){ %> checked="checked" <% } %> title="서비스포인트 30,000P" />서비스포인트 <span class="ls0">30,000P</span> <br />(<span class="ls0">20</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='20' req_cnt='<%=String.valueOf(grade04) %>' inputCss="" /></p>
			</div>
		</div>
		<!-- // 500만원 이상 -->
		<!-- 300만원 이상 -->
		<h2><img src="/html/et/spcialgift10/images/h2_gift_300.gif" alt="02. 목표금액이 300만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<div class="gift1">
				<p><img src="/html/et/spcialgift10/images/img_gift_1005.gif" alt="삼성 스마트 카메라 " /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="11" <% if(item03.equals("11")){ %> checked="checked" <% } %> title="삼성 스마트 카메라 " disabled="disabled" />삼성 스마트 카메라 <br />EX2F (<span class="ls0">2</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='2' req_cnt='<%=String.valueOf(grade11) %>' inputCss="" /></p>
			</div>
			<div class="gift2">
				<p><img src="/html/et/spcialgift10/images/img_gift_1006.gif" alt="정관장 홍삼정 플러스" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="12" <% if(item03.equals("12")){ %> checked="checked" <% } %> title="정관장 홍삼정 플러스" disabled="disabled" />정관장 홍삼정 플러스<br /><span class="ls0">110gX3</span> (<span class="ls0">7</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='7' req_cnt='<%=String.valueOf(grade12) %>' inputCss="" /></p>
			</div>
			<div class="gift3">
				<p><img src="/html/et/spcialgift10/images/img_gift_1003.gif" alt="삼성 기프트카드 50,000원권" /></p>
			...
			<div class="gift4">
				<p><img src="/html/et/spcialgift10/images/img_gift_1007.gif" alt="서비스포인트 20,000P" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="14" <% if(item03.equals("14")){ %> checked="checked" <% } %> title="서비스포인트 20,000P" disabled="disabled" />서비스포인트 <span class="ls0">20,000P</span> <br /> (<span class="ls0">50</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='50' req_cnt='<%=String.valueOf(grade14) %>' inputCss="" /></p>
			</div>
		</div>
		<!-- // 300만원 이상 -->
		<!-- 200만원 이상 -->
		<h2><img src="/html/et/spcialgift10/images/h2_gift_200.gif" alt="02. 목표금액이 200만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<div class="gift1">
				<p><img src="/html/et/spcialgift10/images/img_gift_1008.gif" alt="쌤소나이트 캐리어" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="21" <% if(item03.equals("21")){ %> checked="checked" <% } %> title="쌤소나이트 캐리어 " disabled="disabled" />쌤소나이트 캐리어  <br />B-Lite Sp <span class="ls0">55/20</span><br />(<span class="ls0">V7909003</span>) (<span class="ls0">5</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade21) %>' inputCss="" /></p>
			</div>
			<div class="gift2">
				<p><img src="/html/et/spcialgift10/images/img_gift_1009.gif" alt="랑콤 제니피끄" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="22" <% if(item03.equals("22")){ %> checked="checked" <% } %> title="랑콤 제니피끄" disabled="disabled" />랑콤 제니피끄 <br />액티베이터 30ml<br />  (<span class="ls0">10</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='10' req_cnt='<%=String.valueOf(grade22) %>' inputCss="" /></p>
			</div>
			<div class="gift3">
				<p><img src="/html/et/spcialgift10/images/img_gift_1010.gif" alt="메가박스 주말러브패키지" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="23" <% if(item03.equals("23")){ %> checked="checked" <% } %> title="메가박스 주말러브패키지" disabled="disabled" />메가박스 주말러브패키지 <br />쿠폰 (관람권2매+팝콘L <br />+음료S2잔) (<span class="ls0">30</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='30' req_cnt='<%=String.valueOf(grade23) %>' inputCss="" /></p>
			</div>
			<div class="gift4">
				<p><img src="/html/et/spcialgift10/images/img_gift_1011.gif" alt="서비스포인트 10,000P" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="24" <% if(item03.equals("24")){ %> checked="checked" <% } %> title="서비스포인트 10,000P" disabled="disabled" />서비스포인트 <span class="ls0">10,000P</span> (<span class="ls0">100</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='100' req_cnt='<%=String.valueOf(grade24) %>' inputCss="" /></p>
			</div>
		</div>
		<!-- // 200만원 이상 -->
		<!-- 100만원 이상 -->
		<h2><img src="/html/et/spcialgift10/images/h2_gift_100.gif" alt="04. 목표금액이 100만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<div class="gift1">
				<p><img src="/html/et/spcialgift10/images/img_gift_1012.gif" alt="신세계 백화점 상품권 70,000원" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="31" <% if(item03.equals("31")){ %> checked="checked" <% } %> title="신세계 백화점 상품권 70,000원" disabled="disabled" />신세계 백화점 상품권 <br /><span class="ls0">70,000</span>원 (<span class="ls0">10</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='10' req_cnt='<%=String.valueOf(grade31) %>' inputCss="" /></p>
			</div>
			<div class="gift2">
				<p><img src="/html/et/spcialgift10/images/img_gift_1013.gif" alt="VIPS 주말 샐러드바 1인 이용권" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="32" <% if(item03.equals("32")){ %> checked="checked" <% } %> title="VIPS 주말 샐러드바 1인 이용권" disabled="disabled" />VIPS 주말 샐러드바<br />1인 이용권 (<span class="ls0">30</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='30' req_cnt='<%=String.valueOf(grade32) %>' inputCss="" /></p>
			</div>
			<div class="gift3">
				<p><img src="/html/et/spcialgift10/images/img_gift_1014.gif" alt="문화상품권 10,000원권" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="33" <% if(item03.equals("33")){ %> checked="checked" <% } %> title="문화상품권 10,000원권" disabled="disabled" />문화상품권 10,000원권<br />(온라인전용) (<span class="ls0">100</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='100' req_cnt='<%=String.valueOf(grade33) %>' inputCss="" /></p>
			</div>
			<div class="gift4">
				<p><img src="/html/et/spcialgift10/images/img_gift_1015.gif" alt="서비스포인트 5,000P" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="34" <% if(item03.equals("34")){ %> checked="checked" <% } %> title="서비스포인트 5,000P" disabled="disabled" />서비스포인트 <span class="ls0">5,000P</span><br />(<span class="ls0">150</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='150' req_cnt='<%=String.valueOf(grade34) %>' inputCss="" /></p>
			</div>
		</div>
		<!-- // 100만원 이상 -->
		<!-- 50만원 이상 -->
		<h2><img src="/html/et/spcialgift10/images/h2_gift_50.gif" alt="05. 목표금액이 50만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<div class="gift1">
				<p><img src="/html/et/spcialgift10/images/img_gift_1016.gif" alt="서비스포인트 2개월동안 추가 3% 적립 월 최대 30,000P" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="41" <% if(item03.equals("41")){ %> checked="checked" <% } %> title="서비스포인트 2개월동안 추가 3% 적립 월 최대 30,000P" disabled="disabled" />서비스포인트 2개월동안<br /> 추가 <span class="ls0">3</span>%적립<br />월 최대 <span class="ls0">30,000</span>P (<span class="ls0">30</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='30' req_cnt='<%=String.valueOf(grade41) %>' inputCss="" /></p>
			</div>
			<div class="gift2">
				<p><img src="/html/et/spcialgift10/images/img_gift_1017.gif" alt="서비스포인트 2개월동안 추가 2%적립 월 최대 20,000P" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="42" <% if(item03.equals("42")){ %> checked="checked" <% } %> title="서비스포인트 2개월동안 추가 2%적립 월 최대 20,000P" disabled="disabled" />서비스포인트 2개월동안<br /> 추가 <span class="ls0">2</span>%적립<br />월 최대 <span class="ls0">20,000</span>P (<span class="ls0">70</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='70' req_cnt='<%=String.valueOf(grade42) %>' inputCss="" /></p>
			</div>
			<div class="gift3">
				<p><img src="/html/et/spcialgift10/images/img_gift_1018.gif" alt="GS 주유 쿠폰 5,000원권" /></p>
				<p class="gift_tit"><label><input type="radio"  name="gift1" class="gift_rdo" value="43" <% if(item03.equals("43")){ %> checked="checked" <% } %> title="GS 주유 쿠폰 5,000원권" disabled="disabled" /> GS 주유 쿠폰 <br /> 5,000원권 (<span class="ls0">150</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='150' req_cnt='<%=String.valueOf(grade43) %>' inputCss="" /></p>
			</div>
			<div class="gift4">
				<p><img src="/html/et/spcialgift10/images/img_gift_1019.gif" alt="서비스포인트 3,000P" /></p>
		...
		<!-- // 경품선택 -->
		<!-- 배송지 주소 -->
		<h1><img src="/html/et/spcialgift10/images/h1_step03.gif" alt="STEP 03. 배송받으실 주소를 입력해주세요." /></h1>
		<table>
			...
			<tbody>
				<tr>
					...
					<td>
						...
						<img src="/html/et/spcialgift10/images/btn_add_search.gif" alt="우편번호검색" /></a><br />
		...
		<!-- // 배송지 주소 -->
		<!-- 경품배송 동의안내 -->
		<h1><img src="/html/et/spcialgift10/images/h1_step04.gif" alt="STEP 04. 경품 배송 동의 안내입니다." /></h1>
		...
		<%if(loginYN.equals("N")) {	%>
		<p class="al_center"><a href="#" onclick="parent.eventLogin('33405');return false;"><img src="/html/et/spcialgift10/images/btn_app.gif" alt="응모하기" /></a></p>
		<%		} else {	%>
		<% if("0".equals(item03) || "0".equals(item04)){ %>
        <p class="al_center"><a href="#" onclick="applyEvent();return false;"><img src="/html/et/spcialgift10/images/btn_app.gif" alt="응모하기" /></a></p>
		<% }else{ %>
        <p class="al_center"><a href="#" onclick="applyEvent();return false;"><img src="/html/et/spcialgift10/images/btn_modify.gif" alt="수정하기" /></a></p>
		<% } %>
		<% } %>
		<!-- 삼성카드 special event란? -->
		<p class="mt30"><img src="/html/et/spcialgift10/images/txt_giftspecial_event2.gif" alt="삼성카드 Gift Special 이벤트는 삼성카드를 이용하시는 회원님들께 감사의 마음을 담아 준비한 이벤트로, 정기적으로 회원님을 찾아가려 합니다. 의미있는 상품으로 회원님께 최고의 가치를 제공하려 항상 노력하겠습니다." /></p>
		<!-- // 삼성카드 special event란? -->
	</div>
	...
	<div class="pop_l_position pop_l_wrap_alert" id="id_layer" style="display:none;left:150px">
		<div class="pop_l_wrap"><p class="img_l_pop flag_tl">&nbsp;</p><p class="img_l_pop flag_tr">&nbsp;</p>
			...
			<p class="pop_tit"><img src="/html/et/spcialgift10/images/lay_tit_giftspecial.gif" alt="삼성카드 Gift Special" /></p>
			<p class="pop_tit2"><img src="/html/et/spcialgift10/images/lay_tit_winter4.gif" alt="제10탄 Fall in SAMSUNGCARD" /></p>
			...
			<div class="pop_l_content2">
				<div class="pop_l_alert">
					...
					<table class="dtable01 mt10" summary="목표금액, 현재까지 도달 금액, 목표달성까지 로 구성된 이용금액 안내">
						...
						<tbody>
							...
							<tr>
								<td colspan="3" class="line"><strong>응모경품 :
									...
									VIPS 주말 샐러드바 1인 이용권 (30명)
									<%} else if (item03.equals("33")) {%>
									문화상품권 10,000원권 (온라인전용) (100명)
				...
				<p class="btnc mt20"><a href="#" onclick="document.getElementById('id_layer').style.display='none';closeLayerPopup();"><img src="/html/et/spcialgift10/images/btn_s_confirm.gif" alt="확인" /></a></p>
			</div>
		</div>
	</div>
