...
<title>쉼과 감동이 있는 2012 삼성카드 오토캠핑 樂 - 삼성카드</title>
...
<script language="javascript" type="text/javascript">
	...
	function applyEvent() {
		...
		newsWindow = window.open("/hp/im/et/evt.do?method=getAutoCampingPop2012", "autoCamping" , Future); 
		newsWindow.focus();
	}
...
<img src="/images/et/auto2012/1203 15_autocamp.jpg" alt="쉼과 감동이 있는 2012 삼성카드 오토캠핑 樂 " border="0" usemap="#autocamp" />
<map name="autocamp" id="autocamp">
    <area shape="rect" coords="579,196,689,225" href="#" onclick="go_start();" alt="응모하기" />
    <area shape="rect" coords="274,1146,454,1184" href="#" onclick="go_start();" alt="이벤트 응모하기" />
</map>
<div class="hidden">
	<h1>쉼과 감동이 있는 2012 삼성카드 오토캠핑 락</h1>
	<p>푸른하늘 푸른 숲이 맞닿은 자연 속에서 사랑하는 가족과 함께 하는 휴식과 감동의 시간! 삼성카드 오토캠핑 락 이벤트에 참여하세요. 잊을 수 없는 가족의 추억을 만들어 드립니다.</p>
    <p><a href="#none" onclick="go_start();">응모하기</a></p>
	
	<dl>
		<dt>행사기간</dt>
		<dd>2012년 5월 19일(토) ~ 20일(일) 까지</dd>
		<dt>행사장소</dt>
		...
		<dt>응모기간</dt>
		<dd>2012년 3월 28일(수) ~ 4월 30일(월)까지</dd>
		<dt>당첨자발표</dt>
		<dd>2012년 5월 4일(금) 삼성카드 홈페이지 및 개별 안내</dd>
		<dt>준비물</dt>
