...
<body style="margin:0;">
<form id="evtFrm" name="evtFrm" action="/hp/im/et/evt.do?method=getSclassMovieEventSec" method="post">
...
<span class="t_12">※</span> 위 사항에 동의하셔야만 귀하가 신청하신 이벤트에 참여 하실 수 있습니다.
			...
			<tbody>
				...
				<tr>
					...
					&nbsp;-&nbsp;
					<label><input type="password" class="txt" id="idenNo2" name="idenNo2" maxlength="7" title="주민등록번호 뒷자리"  onkeydown="checkLenB(this, document.evtFrm.idenNo1);" onkeypress="checkTypes(this, 'NUMB');" onblur="checkTypesOnBlur(this, 'NUMB');" style="ime-mode:disabled;width:90px;" onclick="document.evtFrm.idenNo2.value = '';"/></label>
			...
			<div class="btnc"><a href="#" onclick="applyEvent();"><img src="/images/et/sclass/btn_next.png" alt="다음" /></a></div>
		</div>
	</div>
