...
<title>신라호텔가족의 Happy Donation! Vol.2 - 삼성카드</title>
<%
...
<img src="/images/et/donation201205s/event_shilla.jpg" alt="신라호텔가족의 Happy Donation! Vol.2" border="0" usemap="#donation" />
...
<div class="hidden">
	<p>삼성카드가 호텔신라의 창립기념일을 진심으로 축하드립니다.</p>
	<h1>호텔신라 가족의 Happy Donation Vol.2</h1>
	<p>호텔신라의 39주년 창립기념일을 맞이하여 삼성카드가 함께하는 이벤트를 준비하였습니다. 힘겨운 희망의 산을 넘는 현우네 가족을 위한 Happy Donation! 호텔신라 창립기념일부터 한 달(5/9~ 6/8) 동안 후원에 동참하시는 호텔신라 임직원께서
    ...
    <p>호텔신라 가족 여러분 현우 가족이 힘겨운 희망의 산을 넘어 멋진 삶을 살아갈 수 있도록 여러 분들의 사랑을 나누어 주세요! </p>
    <p><a href="#none" onclick="go_start();return false;">후원하기</a></p>
    
    <ul>
        <li>- 기부금액은 후원에 참여하신 호텔신라 임직원이 2012년 5월 한달간 사용하신 삼성카드 일시불+할부 이용금액의 0.1%입니다.</li>
        <li>- 호텔신라 임직원이 모아주신 기부금은 6월에 소아암협회를 통해 현우에게 전달될 예정입니다.</li>
    </ul>
</div>
