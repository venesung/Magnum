...
.quiz1 {position: absolute; left: 128px;top: 923px;}
.quiz2 {position: absolute; left: 311px;top: 923px;}
.quiz3 {position: absolute; left: 494px;top: 923px;}
.quiz1 img,.quiz2 img,.quiz3 img {margin: 4px 0 0 5px;display: inline-block;}
...
<script language="javascript" type="text/javascript">
	...
	function applyEvent() {
		...
		if(gubun == ""){
			...
			if (gubun == "1") {
				window.open('','pop201110','menubar=0,resizable=0,scrollbars=0,width=470,height=474,left=0,top=0');
			} else if (gubun == "2") {
				window.open('','pop201110','menubar=0,resizable=0,scrollbars=0,width=470,height=474,left=0,top=0');
			} else if (gubun == "3") {
				window.open('','pop201110','menubar=0,resizable=0,scrollbars=0,width=470,height=474,left=0,top=0');
			...
			frm.target = 'pop201110';
			frm.action = '/hp/im/et/evt002.do?method=getQuiz201110pop';
			frm.submit();
		}		
	}
...
<p class="quiz1"><label for="quiz1"><input type="radio" class="type-radio" id="quiz1" value="1" checked="checked" name="quiz"  />
<img src="/images/et/quiz201110/txt_quiz1.png" alt="삼성빅앤빅카드" /><span class="conts_hidden">삼성빅앤빅카드</span></label></p>
<p class="quiz2"><label for="quiz2"><input type="radio" class="type-radio" id="quiz2" value="2" name="quiz" />
<img src="/images/et/quiz201110/txt_quiz2.png" alt="삼성티클래스카드" /><span class="conts_hidden">삼성티클래스카드</span></label></p>
<p class="quiz3"><label for="quiz3"><input type="radio" class="type-radio" id="quiz3" value="3" name="quiz" />
<img src="/images/et/quiz201110/txt_quiz3.png" alt="삼성카드 S클래스" /><span class="conts_hidden">삼성카드 S클래스</span></label></p>
</div>
</form>
</body>
