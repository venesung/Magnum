...
<title>새해에는 종은 일만 가득하길- GIFT Special - 삼성카드</title>
<style type="text/css">
...
.giftevent_btm	{width:728px; height:65px; background:url('/html/et/spcialgift11/images/bg_tmp_btm.gif') no-repeat}
.giftevent	{height:100%; background:url('/html/et/spcialgift11/images/bg_tmp_mid.gif') repeat-y; padding:0 49px}
...
th	{color:#333; padding:6px 0 5px 10px; text-align:left; font:normal 12px '돋움'; border-top:1px solid #dadada; border-bottom:1px solid #dadada; line-height:18px}
...
.gift_bg	{position:relative; width:630px; height:205px; background:url('/html/et/spcialgift11/images/bg_event_gift.jpg') no-repeat; margin-bottom:10px}
.gift_bg	img	{height:85px}
.gift_bg	.gift1	{position:absolute; top: 5px; left:13px; width:150px}
.gift_bg	.gift2	{position:absolute; top: 5px; left:171px; width:150px}
.gift_bg	.gift3	{position:absolute; top: 5px; left:332px; width:150px}
.gift_bg	.gift4	{position:absolute; top: 5px; left:494px; width:150px}
...
.box_white	 {position:relative; background: url('/html/et/spcialgift11/images/box_white.gif') no-repeat}
...
.box_white_btm	 {padding:10px; background:url('/html/et/spcialgift11/images/box_white.gif') no-repeat right bottom}
...
<script language="javascript" type="text/javascript">
	...
	function pop201211() {
		window.open('/html/et/spcialgift11/event.html','pop201211','menubar=0,resizable=0,scrollbars=0,width=710,height=610,left=0,top=0');
	}
	function applyEvent() {
		var chkCheckbox = "N";
...
<%}%>
		...
		if ((document.form1.gift1[3].checked) ||
			    ...
			    (document.form1.gift1[16].checked) ||
			    (document.form1.gift1[17].checked) ||
		...
		document.form1.action="/hp/im/et/evt003.do?method=applySpecialGiftEvent11";
...
<div id="special_gift">
	...
	<p>
        <img src="/html/et/spcialgift11/images/event_gift_special_11.jpg" alt="새해에는 종은 일만 가득하길- GIFT Special" />
        <div class="hidden">
            <h1>새해에는 좋은 일만 가득하길- GIFT Special</h1>
            <p>저물어가는 2012년을 아쉬워하지 마세요. 새롭게 다가오는 2013년이 있으니까요. 회원님의 행운 가득한 새해를 위해 삼성카드가 특별한 선물을 준비했습니다!</p>
            <dl>
                <dt>행사기간</dt>
                <dd>2012년 12월 3일(월) ~ 12월 31일(월)</dd>
                <dt>행사내용</dt>
                <dd>회원님께서 직접 원하시는 선물과 목표금액을 선택하시고 행사기간 동안 정해진 목표금액 이상 이용 시 추첨을 통해 선물을 드립니다. - 목표금액은 2012년 9~10월 월평균 일시불 및 할부 이용금액보다 높은 금액으로만 응모하실 수 있습니다.</dd>
                <dt>당첨자발표</dt>
                <dd>2012년 1월 18일(금) 삼성카드 홈페이지 이벤트 당첨자발표란</dd>
                <dt>포인트적립 및 경품 배송</dt>
                <dd>2012년 1월 25일(금) 예정</dd>
                <dt>참여방법</dt>
                <dd>자신이 원하는 선물 확인 → 목표금액 및 선물 선택 → 기간 내 목표금액 달성 → 추첨 후 당첨 회원님께 선물 제공</dd>
            </dl>
        </div>
    </p>
	<div class="giftevent">
		<p class="al_center mb10"><a id="NHPIMETEVTVIEW556_L01" href="#" onclick="eventPayView();fnSetReturnFocusId('NHPIMETEVTVIEW556_L01','id_layer');"><img src="/html/et/spcialgift11/images/btn_payview.gif" alt="현재까지 이용금액 보기" /></a></p>
		<!-- 목표금액 설정 -->
		<h1 class="mt60"><img src="/html/et/spcialgift11/images/h1_step01.gif" alt="STEP 01. 목표금액을 설정해주세요." />지난 2개월동안 회원님의 월평균 이용금액은 <strong class="t_point_org t_no"><%=StringUtil.replace(approveSum,".5","") %></strong>원 입니다.</h1>
		...
		<!-- // 목표금액 설정 -->
		<!-- 경품선택 -->
		<h1><img src="/html/et/spcialgift11/images/h1_step02.gif" alt="STEP 02. 경품을 선택 해주세요." />&nbsp;&nbsp;<a href="#" onclick="pop201211();" title="새창"><img src="/html/et/spcialgift11/images/btn_countryview2.gif" alt="경품 자세히 보기" /></a></h1>

		<!-- 500만원 이상 -->
		<h2 class="gift1"><img src="/html/et/spcialgift11/images/h2_gift_500.gif" alt="01. 목표금액이 500만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 삼성 버블샷2 드럼세탁기 -->
			<div class="gift1">
				<p><img src="/html/et/spcialgift11/images/img_gift_1001.gif" alt="삼성 버블샷2 드럼세탁기 " /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="01" <% if(item03.equals("01")){ %> checked="checked" <% } %> title="삼성 버블샷2 드럼세탁기" />삼성 버블샷2 드럼세탁기<br /><span class="ls0">WD139ACHRWR</span><br />(세탁<span class="ls0">13kg</span>/건조<span class="ls0">8kg</span>)(<span class="ls0">1</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='1' req_cnt='<%=String.valueOf(grade01) %>' inputCss="" /></p>
			</div>
			<!-- 삼성 공기청정기 -->
			<div class="gift2">
				<p><img src="/html/et/spcialgift11/images/img_gift_1002.gif" alt="삼성 공기청정기" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="02" <% if(item03.equals("02")){ %> checked="checked" <% } %> title="삼성 공기청정기" />삼성 공기청정기<br /><span class="ls0">HC-M530MT</span> (<span class="ls0">3</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='3' req_cnt='<%=String.valueOf(grade02) %>' inputCss="" /></p>
			</div>
			<!-- 삼성Gift카드 100,000원권 -->
			<div class="gift3">
				<p><img src="/html/et/spcialgift11/images/img_gift_1003.gif" alt="삼성 기프트카드  100,000원권" /></p>
				<p class="gift_tit"><input type="radio" name="gift1" class="gift_rdo" value="03" <% if(item03.equals("03")){ %> checked="checked" <% } %> title="삼성 기프트카드 100,000원권 " />삼성<span class="ls0">Gift</span>카드<br /><span class="ls0">100,000</span>원권 (<span class="ls0">7</span>명)</p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='7' req_cnt='<%=String.valueOf(grade03) %>' inputCss="" /></p>
			</div>
			<!-- 30,000 서비스포인트 -->
			<div class="gift4">
				<p><img src="/html/et/spcialgift11/images/img_gift_1004.gif" alt="30,000 서비스포인트" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="04" <% if(item03.equals("04")){ %> checked="checked" <% } %> title="30,000 서비스포인트" /><span class="ls0">30,000</span> 서비스포인트<br />(<span class="ls0">20</span>명)</label></p>
		...
		<!-- 300만원 이상 -->
		<h2><img src="/html/et/spcialgift11/images/h2_gift_300.gif" alt="02. 목표금액이 300만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 삼성 아티브스마트PC -->
			<div class="gift1">
				<p><img src="/html/et/spcialgift11/images/img_gift_1005.gif" alt="삼성 아티브스마트PC " /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="11" <% if(item03.equals("11")){ %> checked="checked" <% } %> title="삼성 아티브스마트PC" disabled="disabled"/>삼성 아티브스마트PC<br /><span class="ls0">XQ501T1C-AN01Z</span><br />(<span class="ls0">2</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='2' req_cnt='<%=String.valueOf(grade11) %>' inputCss="" /></p>
			</div>
			<!-- 님프만 거위이불솜   -->
			<div class="gift2">
				<p><img src="/html/et/spcialgift11/images/img_gift_1006.gif" alt="님프만 거위이불솜" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="12" <% if(item03.equals("12")){ %> checked="checked" <% } %> title="님프만 거위이불솜" disabled="disabled"/>님프만 거위이불솜<br />퀸사이즈 (<span class="ls0">7</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='7' req_cnt='<%=String.valueOf(grade12) %>' inputCss="" /></p>
			</div>
			<!-- 삼성 기프트카드 50,000원권 -->
			<div class="gift3">
				<p><img src="/html/et/spcialgift11/images/img_gift_1003.gif" alt="삼성 기프트카드 50,000원권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="13" <% if(item03.equals("13")){ %> checked="checked" <% } %> title="삼성 기프트카드 50,000원권" disabled="disabled"/>삼성 기프트카드<br /><span class="ls0">50,000</span>원권 (<span class="ls0">25</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='25' req_cnt='<%=String.valueOf(grade13) %>' inputCss="" /></p>
			</div>
			<!-- 20,000 서비스포인트 -->
			<div class="gift4">
				<p><img src="/html/et/spcialgift11/images/img_gift_1007.gif" alt="20,000 서비스포인트" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="14" <% if(item03.equals("14")){ %> checked="checked" <% } %> title="20,000 서비스포인트" disabled="disabled"/><span class="ls0">20,000</span> 서비스포인트<br />(<span class="ls0">25</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='25' req_cnt='<%=String.valueOf(grade14) %>' inputCss="" /></p>
			</div>
		</div>
		<!-- // 300만원 이상 -->
		
		<!-- 200만원 이상 -->
		<h2><img src="/html/et/spcialgift11/images/h2_gift_200.gif" alt="02. 목표금액이 200만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!--필립스 에어프라이어 -->
			<div class="gift1">
				<p><img src="/html/et/spcialgift11/images/img_gift_1008.gif" alt="필립스 에어프라이어" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="21" <% if(item03.equals("21")){ %> checked="checked" <% } %> title="필립스 에어프라이어" disabled="disabled"/>필립스 에어프라이어<br /><span class="ls0">HD-9220</span>(<span class="ls0">5</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='5' req_cnt='<%=String.valueOf(grade21) %>' inputCss="" /></p>
			</div>
			<!-- 스와로브스키 -->
			<div class="gift2">
				<p><img src="/html/et/spcialgift11/images/img_gift_1009.gif" alt="스와로브스키" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="22" <% if(item03.equals("22")){ %> checked="checked" <% } %> title="스와로브스키" disabled="disabled"/>스와로브스키<br />백조 목걸이(<span class="ls0">10</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='10' req_cnt='<%=String.valueOf(grade22) %>' inputCss="" /></p>
			</div>
			<!-- CGV 영화관람권 2매 -->
			<div class="gift3">
				<p><img src="/html/et/spcialgift11/images/img_gift_1010.gif" alt="CGV 영화관람권 2매" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="23" <% if(item03.equals("23")){ %> checked="checked" <% } %> title="CGV 영화관람권 2매" disabled="disabled"/>CGV 영화관람권 2매<br />모바일쿠폰(<span class="ls0">30</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='30' req_cnt='<%=String.valueOf(grade23) %>' inputCss="" /></p>
			</div>
			<!-- 10,000 서비스포인트-->
			<div class="gift4">
				<p><img src="/html/et/spcialgift11/images/img_gift_1011.gif" alt="10,000 서비스포인트" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="24" <% if(item03.equals("24")){ %> checked="checked" <% } %> title="10,000 서비스포인트" disabled="disabled"/><span class="ls0">10,000</span> 서비스포인트<br />(<span class="ls0">100</span>명)</label></p>
		...
		<!-- 100만원 이상 -->
		<h2><img src="/html/et/spcialgift11/images/h2_gift_100.gif" alt="04. 목표금액이 100만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 신세계상품권 50,000원 -->
			<div class="gift1">
				<p><img src="/html/et/spcialgift11/images/img_gift_1012.gif" alt="신세계상품권 50,000원" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="31" <% if(item03.equals("31")){ %> checked="checked" <% } %> title="신세계 백화점 상품권 50,000원" disabled="disabled"/>신세계상품권<br /><span class="ls0">50,000</span>원권 (<span class="ls0">10</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='10' req_cnt='<%=String.valueOf(grade31) %>' inputCss="" /></p>
			</div>
			<!-- 도미노피자 -->
			<div class="gift2">
				<p><img src="/html/et/spcialgift11/images/img_gift_1013.gif" alt="도미노피자" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="32" <% if(item03.equals("32")){ %> checked="checked" <% } %> title="도미노피자" disabled="disabled"/>도미노피자<br />포테이토피자(L)+콜라<br />모바일쿠폰 (<span class="ls0">30</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='30' req_cnt='<%=String.valueOf(grade32) %>' inputCss="" /></p>
			</div>
			<!-- CJ 모바일상품권 -->
			<div class="gift3">
				<p><img src="/html/et/spcialgift11/images/img_gift_1014.gif" alt="CJ 모바일상품권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="33" <% if(item03.equals("33")){ %> checked="checked" <% } %> title="CJ 모바일상품권" disabled="disabled"/>CJ 모바일상품권<br />1만원권 (<span class="ls0">100</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='100' req_cnt='<%=String.valueOf(grade33) %>' inputCss="" /></p>
			</div>
			<!-- 5,000 서비스포인트 -->
			<div class="gift4">
				<p><img src="/html/et/spcialgift11/images/img_gift_1015.gif" alt="5,000 서비스포인트" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="34" <% if(item03.equals("34")){ %> checked="checked" <% } %> title="5,000 서비스포인트" disabled="disabled"/><span class="ls0">5,000</span> 서비스포인트 <br />(<span class="ls0">150</span>명)</label></p>
		...
		<!-- 50만원 이상 -->
		<h2><img src="/html/et/spcialgift11/images/h2_gift_50.gif" alt="05. 목표금액이 50만원 이상인 경우" /></h2>
		<div class="gift_bg">
			<!-- 2개월 동안 3% 서비스 -->
			<div class="gift1">
				<p><img src="/html/et/spcialgift11/images/img_gift_1016.gif" alt="2개월 동안 3% 서비스" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="41" <% if(item03.equals("41")){ %> checked="checked" <% } %> title="2개월 동안 3% 서비스" disabled="disabled"/>2개월 동안 <span class="ls0">3</span>% 서비스<br />포인트 추가 적립<br />월 최대 <span class="ls0">30,000</span>P (<span class="ls0">30</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='30' req_cnt='<%=String.valueOf(grade41) %>' inputCss="" /></p>
			</div>
			<!-- 파리바게뜨 케익교환권 -->
			<div class="gift2">
				<p><img src="/html/et/spcialgift11/images/img_gift_1018.gif" alt="파리바게뜨 케익교환권" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="42" <% if(item03.equals("42")){ %> checked="checked" <% } %> title="파리바게뜨 케익교환권" disabled="disabled"/>파리바게뜨 케익교환권<br />2만원권 모바일쿠폰<br />(<span class="ls0">70</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='70' req_cnt='<%=String.valueOf(grade42) %>' inputCss="" /></p>
			</div>
			<!-- 5,000 서비스포인트 -->
			<div class="gift3">
				<p><img src="/html/et/spcialgift11/images/img_gift_1015.gif" alt="5,000 서비스포인트" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="43" <% if(item03.equals("43")){ %> checked="checked" <% } %> title="5,000 서비스포인트" disabled="disabled"/><span class="ls0">5,000</span> 서비스포인트<br />(<span class="ls0">150</span>명)</label></p>
				<p class="gift_txt"><fileTag:emzCommon pdt_cnt='150' req_cnt='<%=String.valueOf(grade43) %>' inputCss="" /></p>
			</div>
			<!-- 3,000 서비스포인트 -->
			<div class="gift4">
				<p><img src="/html/et/spcialgift11/images/img_gift_1019.gif" alt="3,000 서비스포인트" /></p>
				<p class="gift_tit"><label><input type="radio" name="gift1" class="gift_rdo" value="44" <% if(item03.equals("44")){ %> checked="checked" <% } %> title="3,000 서비스포인트"  disabled="disabled"/><span class="ls0">3,000</span> 서비스포인트<br />(<span class="ls0">200</span>명)</label></p>
		...
		<!-- 배송지 주소 -->
		<h1><img src="/html/et/spcialgift11/images/h1_step03.gif" alt="STEP 03. 배송받으실 주소를 입력해주세요." /></h1>
		...
		<!-- // 배송지 주소 -->
		<!-- 경품배송 동의안내 -->
		<h1><img src="/html/et/spcialgift11/images/h1_step04.gif" alt="STEP 04. 경품 배송 동의 안내입니다." /></h1>
		...
		<%if(loginYN.equals("N")) {	%>
		<p class="al_center"><a href="#" onclick="parent.eventLogin('13087');return false;"><img src="/html/et/spcialgift11/images/btn_app.gif" alt="응모하기" /></a></p>
		<%		} else {	%>
		<% if("0".equals(item03) || "0".equals(item04)){ %>
		...
		<% } %>
		<!-- 삼성카드 special event란? -->
		<p class="mt30"><img src="/html/et/spcialgift11/images/txt_giftspecial_event2.gif" alt="삼성카드 Gift Special 이벤트는 삼성카드를 이용하시는 회원님들께 감사의 마음을 담아 준비한 이벤트로, 정기적으로 회원님을 찾아가려 합니다. 의미있는 상품으로 회원님께 최고의 가치를 제공하려 항상 노력하겠습니다." /></p>
        <div class="hidden">
			<h2>삼성카드 Gift Special 이벤트는?</h2>
			<p>삼성카드를 이용하시는 회원님들께 감사의 마음을 담아 준비한 이벤트로, 정기적으로 회원님을 찾아가려 합니다. 의미있는 상품으로 회원님께 최고의 가치를 제공하려 항상 노력하겠습니다.</p>
			<ol>
				<li>삼성카드 명품 지역 특산물 편(2011년 3월 진행) : 신세계백화점에서 선정한 명품 지역특산물 등 20여가지의 경품을 추첨을 통해 회원 3,000분께 드렸습니다.</li>
				<li>삼성카드 상품권 콜렉션편(2011년 6월 진행) : 생활에 유용한 각종 상품권 등 20여가지 경품을 추첨을 통해 회원 3,000분께 드렸습니다.</li>
				<li>삼성카드 한가위 선물(2011년 8월 진행) : 추석을 맞이해 삼성 LED TV, 올림푸스 디지털 카메라, 정관장 홍삼세트 등 20여가지 한가위 선물을 추첨을 통해 회원 3,000분께 드렸습니다.</li>
				<li>삼성카드 가을 이야기(2011년 10월 진행) : 계절에 어울리는 김치냉장고, 벹나 에어워셔 가습공기청정기, 네스프레소 에스프레소 머신 등 20여가지 가을 선물을 추첨을 통해 회원 2,000분께 드렸습니다.</li>
				<li>삼성카드 임진년 새해선물(2011년 12월 진행) : 새해를 맞이해 양문형냉장고, 식기세척기, 캠코더, 휴롬 천연원액기 등 20여가지 새해맞이선물을 추첨을 통해 회원 2,000분께 드렸습니다.</li>
				<li>삼성카드 새 출발 선물92012년 2월 진행) : 새 학기를 맞이해 노트북, 갤럭시탭, 디지털카메라 등 20여 개의 새 학기 선물을 추첨을 통해 회원 2,012분께 드렸습니다.</li>
				<li>삼성카드 온 가족 만족 선물(2012년 4월 진행) : 가정의 달, 가족의 행복을 위해 LED TV, 로봇청소기 등 20여 가지 가족선물을 추첨을 통해 회원 1,719분께 드렸습니다.</li>
				<li>삼성카드 Early Summer Event(2012년 6월 진행) : 여름 휴가를 맞아, 가족과 함께 즐거운 휴가를 위해 디지털카메라 등 20여 가지 선물을 추첨을 통해 회원 1,719분께 드렸습니다.</li>
				<li>삼성카드 미리 준비하는 한가위(2012년 8월 진행) : 한가위를 한달 먼저 준비하는 센스있는 회원님을 위해 삼성 LED TV, 르쿠르제 캠핑셋트 등 20여가지 다양한 선물을 추첨을 통해 회원 1,000분께 드렸습니다.</li>
				<li>삼성카드 Fall in SAMSUNGCARD(2012년 10월 진행) : 단풍과 함께 성큼 다가온 가을, 삼성카드가 따뜻한 감성으로 준비한 김치냉장고, 스마트 카메라 등 20여가지 다양한 선물을 추첨을 통해 회원 1,000분께 드렸습니다.</li>
			</ol>
			<ul>
				<li>결제 취소 시 이용금액에서 제외되며, 확정된 경품은 변경되지 않습니다.</li>
				<li>5만원 초과 경품의 제세공과금(22%)은 당첨 회원님 본인 부담이며, 당첨자 발표 후 일주일 내 미입금 시 당첨이 취소됩니다.</li>
				<li>목표금액 미달성 시 추첨대상에서 제외됩니다.</li>
				<li>국내 이용내역에 한하여, 교통카드 및 후불하이패스 이용내역은 이용금액에서 제외됩니다.</li>
				<li>법인/체크/선불/올앳/기프트카드는 제외됩니다.</li>
				<li>카드사 및 제휴사의 사정으로 변경 &middot; 중단 될 수 있으며, 그 내용을 사전에 알려 드립니다.</li>
			</ul>
		</div>
		<!-- // 삼성카드 special event란? -->
	</div>
	...
	<div class="pop_l_position pop_l_wrap_alert" id="id_layer" style="display:none;left:150px">
		<div class="pop_l_wrap"><p class="img_l_pop flag_tl">&nbsp;</p><p class="img_l_pop flag_tr">&nbsp;</p>
			...
			<p class="pop_tit"><img src="/html/et/spcialgift11/images/lay_tit_giftspecial.gif" alt="삼성카드 Gift Special" /></p>
			<p class="pop_tit2"><img src="/html/et/spcialgift11/images/lay_tit_winter4.gif" alt="제10탄 Fall in SAMSUNGCARD" /></p>
			<p class="pop_txt">목표금액을 달성하셔야 선택하신 경품의 추첨대상이 될 수 있습니다.</p>
			<div class="pop_l_content2">
				...
				<p class="btnc mt20"><a href="#" onclick="document.getElementById('id_layer').style.display='none';closeLayerPopup();"><img src="/html/et/spcialgift11/images/btn_s_confirm.gif" alt="확인" /></a></p>
			</div>
		</div>
	</div>
