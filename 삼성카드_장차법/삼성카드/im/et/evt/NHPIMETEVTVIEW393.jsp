...
<title>Enjoy Spring EVENT - 삼성카드</title>
<%
...
<p><img src="/images/event/jeju_event_110412.jpg" alt="Enjoy Spring EVENT" usemap="#jeju" /></p>
<map name="jeju" id="jeju">
  <area shape="circle" coords="597,819,51" href="javascript:go_start();" alt="이벤트 응모하기" />
</map>
</body>
