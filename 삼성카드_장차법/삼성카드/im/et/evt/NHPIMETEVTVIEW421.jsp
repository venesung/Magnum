...
<div id="pop_wrap">
	...
	<div id="pop_content" class="h460">
		<div class="content_block content_block_card">
			...
			<table class="dtable02 dtable_expand mt10" summary="남은악어개수, 악어룰렛도전기회, 획득포인트 등 악어룰렛 이용내역을 알 수 있는 게시판입니다.">
			<caption>악어룰렛 이용내역</caption>
			...
			<table class="dtable01 mt10" summary="카드 이용일, 카드명, 이용가맹점명, 승인번호, 이용금액, 악어룰렛 도전 기회 등 악어룰렛 이용내역을 알 수 있는 게시판입니다.">
			<caption>악어룰렛 이용내역</caption>
