...
<title>대구에서 만나는 뮤지컬 모차르트 - 삼성카드</title>
<%
...
<script language="javascript" type="text/javascript">
	...
	function go_start(type) {
		<%
			if(loginYN.equals("N")){ 
		%>
			parent.eventLogin('252'); //운영계 
			//parent.eventLogin('155');   //개발계
		<%
			}else{
		%>
...
<body style="margin:0;">
	...
	<map name="event_mozart" id="event_mozart">
		<area shape="rect" coords="276,797,454,846" alt="공연 자세히 보기" target="_blank" href="http://www.musicalmozart.co.kr/" title="새창" />
