...
<!-- 
            <li class="on"><a href="javascript:goTabPage('NHPIMETEVT103',true);return false;">럭투유카드</a>
				<ul class="sub_tab">
                    ...
                    <li class="on"><a href="javascript:goTabPage('NHPIMETEVT104',true);return false;">이용 및 혜택 안내</a></li>
...
<!-- 2012.12.28 VOC 추가 start -->
                    ...
                    <li class="on"><a href="javascript:goTabPage('NHPIMETEVT104',true);">이용 및 혜택 안내</a></li>
...
<!--cms_content시작-->
<div id="cma_content">
	<cms:include page="/cms_content/hp/im/et/evt/NHPIMETEVTVIEW104C1.html" flush="false" />
</div>
<!--cms_content끝-->
