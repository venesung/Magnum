...
<body>
<form name="form1" action="/hp/im/et/evt.do?method=setAutoCampingPop2012" method="post">
		...
		<div class="content_block content_block_card clfix">
				...
				<div class="d_desc mb30">
					<span class="input_phone">
						...
						</select>&nbsp;-&nbsp;<input type="text" name="tel2" maxlength="4" style="ime-mode:disabled" class="txt" value="" onkeypress="checkLenN(this, 4, document.form1.tel3);" title="휴대폰 가운데자리" />&nbsp;-&nbsp;
						<input type="text" name="tel3" maxlength="4" style="ime-mode:disabled" class="txt" value="" title="휴대폰 뒷자리" />
					</span>
				</div>
				...
				<div class="" >
					...
					<p class="mb20">이벤트의 진행과 당첨자 발표 및 "삼성카드 오토캠핑 樂 " 행사 진행목적으로 아래 내용의 개인정보를 수집합니다.<br />- 캠핑장비장비 보유여부, 행사 참여 사연, 연락처</p>
