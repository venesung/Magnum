...
#pop_header	 {width:100%; height:60px; background:url('/images/et/wicked201208/pop_bg_body.jpg') no-repeat left top}
#pop_header	 h1	{padding:19px 0 0 25px; font-size:0; line-height:0; background:transparent}
#pop_footer	 .btn_close	{position:absolute; right:12px; top:4px; width:24px; height:24px; background:url('/images/et/wicked201208/pop_bg_body.jpg') no-repeat 663px 0}
#pop_content	 {position:relative; width:100%; height:292px; margin:20px 0; overflow:auto}
#pop_footer	{position:relative; width:100%; height:30px; background:url('/images/et/wicked201208/pop_bg_body.jpg') no-repeat left bottom}
...
<form id="evtFrm" name="evtFrm" action="/hp/im/et/evt002.do?method=setWicked201208" method="post">
...
<div id="pop_wrap" style="overflow:auto;width:710px;" >
	<!-- header -->
	<div id="pop_header">
		<h1><img src="/images/et/wicked201208/h1_musical_1.png" alt="응모하기-뮤지컬 위키드" /></h1>		
	</div>
	...
	<div id="pop_content3" >
		<div class="content_block content_block_card clfix">
			...
			<p><strong>추첨인원</strong><span style="padding-left:30px;">회당 5명, 총 215분 추첨</span></p>		
			
			<table summary="뮤지컬 위키드의 공연일시을 확인하시고 응모를 하실 수 있습니다." class="mt20 dtable02">
			<caption>응모하기-뮤지컬 위키드</caption>
			<colgroup><col width="120" /><col width="66" /><col width="66" /><col width="66" /><col width="66" /><col width="66" /><col width="66" /><col width="66" /><col width="*" /></colgroup>
			<tbody>
			<tr>
				...
				<td class="al_center"></td>
				<td class="al_center"></td>
				<td class="al_center">9/1(토)<br />14:00</td>
				<td class="al_center">9/1(토)<br />20:00</td>
				<td class="al_center">9/2(일)<br />13:00</td>
				<td class="al_center">9/2(일)<br />19:00</td>
			</tr>
				<tr>
			...
			<tr>
				<th class="riline"><p>공연일시</p></th>
				<td class="al_center">9/4(화) <br />20:00</td>
				<td class="al_center">9/5(수)<br />20:00</td>
				<td class="al_center">9/6(목)<br />20:00</td>
				<td class="al_center">9/7(금) <br />20:00</td>
				<td class="al_center">9/8(토)<br />14:00</td>
				<td class="al_center">9/8(토)<br />20:00</td>
				<td class="al_center">9/9(일)<br />13:00</td>
				<td class="al_center">9/9(일)<br />19:00</td>
			</tr>
				<tr>
				<th class="riline"><p>응모하기</p></th>
			...
			<table summary="뮤지컬 위키드의 공연일시을 확인하시고 응모를 하실 수 있습니다." class="mt20 dtable02">
			<caption>응모하기-뮤지컬 위키드</caption>
			<colgroup><col width="120" /><col width="75" /><col width="75" /><col width="75" /><col width="75" /><col width="75" /><col width="75" /><col width="*"/></colgroup>
			<tbody>
			<tr>
				<th class="riline"><p>공연일시</p></th>
				<td class="al_center">9/11(화)<br />20:00</td>
				<td class="al_center">9/12(수)<br />20:00</td>
				<td class="al_center">9/13(목)<br />20:00</td>
				<td class="al_center">9/15(토)<br />14:00</td>
				<td class="al_center">9/15(토)<br />20:00</td>
				<td class="al_center">9/16(일)<br />13:00</td>
				<td class="al_center">9/16(일)<br />19:00</td>
			</tr>
				<tr>
				<th class="riline"><p>응모하기</p></th>
			...
			<table summary="뮤지컬 위키드의 공연일시을 확인하시고 응모를 하실 수 있습니다." class="mt20  dtable02">
			<caption>응모하기-뮤지컬 위키드</caption>
			<colgroup><col width="120" /><col width="58" /><col width="58" /><col width="58" /><col width="58" /><col width="58" /><col width="58" /><col width="58" /><col width="58" /><col width="*"/></colgroup>
			<tbody>
			<tr>
				<th class="riline"><p>공연일시</p></th>
				<td class="al_center">9/18(화) <br />20:00</td>
				<td class="al_center">9/19(수)<br />14:00</td>
				<td class="al_center">9/19(수)<br />20:00</td>
				<td class="al_center">9/20(목) <br />20:00</td>
				<td class="al_center">9/21(금)<br />20:00</td>
				<td class="al_center">9/22(토)<br />14:00</td>
				<td class="al_center">9/22(토)<br />20:00</td>
				<td class="al_center">9/23(일)<br />13:00</td>
				<td class="al_center">9/23(일)<br />19:00</td>
			</tr>
				<tr>
				<th class="riline"><p>응모하기</p></th>
			...
			<tr>
				<th class="riline"><p>공연일시</p></th>
				<td class="al_center">9/25(화) <br />20:00</td>
				<td class="al_center">9/26(수)<br />14:00</td>
				<td class="al_center">9/26(수)<br />20:00</td>
				<td class="al_center">9/27(목) <br />20:00</td>
				<td class="al_center">9/28(금)<br />20:00</td>
				<td class="al_center">9/29(토)<br />13:00</td>
				<td class="al_center">9/29(토)<br />19:00</td>
				<td class="al_center">9/30(일)<br />18:00</td>
			</tr>
				<tr>
				<th class="riline"><p>응모하기</p></th>
			...
			<tr>
				<th class="riline"><p>공연일시</p></th>
				<td class="al_center">10/2(화) <br />19:00</td>
				<td class="al_center">10/3(수) <br />13:00</td>
				<td class="al_center">10/3(수) <br />19:00</td>
				<td class="al_center">10/5(금) <br />20:00</td>
				<td class="al_center">10/6(토) <br />14:00</td>
				<td class="al_center">10/6(토) <br />20:00</td>
				<td class="al_center">10/7(일) <br />13:00</td>
			</tr>
				<tr>
				<th class="riline"><p>응모하기</p></th>
				...
				<td class="al_center"><a href="#" onclick="goApply('40');return false;" class="btn_link"  >응모</a></td>
				<td class="al_center"><a href="#" onclick="goApply('41');return false;" class="btn_link"  >응모</a></td>
				<td class="al_center"><a href="#" onclick="goApply('42');return false;" class="btn_link"  >응모</a></td>
				<td class="al_center"><a href="#" onclick="goApply('43');return false;" class="btn_link"  >응모</a></td>
			</tr>
			</tbody>
			</table>
		</div>
...
<!-- 레이어팝업-최초응모시 -->
	<div id="id_layer01" class="pop_l_position pop_l_wrap_mix" style="display:none">
		<div class="pop_l_wrap"><p class="img_l_pop flag_tl">&nbsp;</p><p class="img_l_pop flag_tr">&nbsp;</p><p class="img_l_pop flag_bl">&nbsp;</p><p class="img_l_pop flag_br">&nbsp;</p><input type="button" class="img_l_pop btn_close btn_input" onclick="this.parentNode.parentNode.style.display='none';" value="레이어닫기" title="응모하기 레이어 닫기" />
			<p class="pop_tit"><img src="/images/et/wicked201208/layer_title_1.png" alt="아래의 공연일시를선택하셨습니다.응모하시겠습니까?" /></p>
...
<!-- 레이어팝업-이벤트확인 클릭시 -->
	<div id="id_layer02" class="pop_l_position pop_l_wrap_mix" style="display:none">
		<div class="pop_l_wrap"><p class="img_l_pop flag_tl">&nbsp;</p><p class="img_l_pop flag_tr">&nbsp;</p><p class="img_l_pop flag_bl">&nbsp;</p><p class="img_l_pop flag_br">&nbsp;</p><input type="button" class="img_l_pop btn_close btn_input" onclick="self.close();" value="레이어닫기" title="응모하기 레이어 닫기" />
			<p class="pop_tit"><img src="/images/et/wicked201208/layer_tit_4.png" alt="아래와 같이 응모되셨습니다." /></p>
				<div class="pop_l_content">
					<div class="pop_l_alert" style="height:100px;padding:30px 0 0 100px;">
					<p class="pop_sub_desc">공연명 :<strong>뮤지컬 &lt;위키드&gt;</strong></p>
...
<!-- 레이어팝업-이벤트 재응모시  -->
	<div id="id_layer03" class="pop_l_position pop_l_wrap_mix" style="display:none">
		<div class="pop_l_wrap" style="height:400px"><p class="img_l_pop flag_tl">&nbsp;</p><p class="img_l_pop flag_tr">&nbsp;</p><p class="img_l_pop flag_bl">&nbsp;</p><p class="img_l_pop flag_br">&nbsp;</p><input type="button" class="img_l_pop btn_close btn_input" onclick="this.parentNode.parentNode.style.display='none';" value="레이어닫기" title="응모하기 레이어 닫기" />
			<p class="pop_tit"><img src="/images/et/wicked201208/layer_title_2.png" alt="회원님께선 이미 응모하셨습니다." /></p>
				<div class="pop_l_content">
			...
			<p class="pop_tit" style="margin-top:30px;"><img src="/images/et/wicked201208/layer_tit_3.png" alt="아래 공연일시로 변경하시겠습니까?" /></p>
				<div class="pop_l_content">
