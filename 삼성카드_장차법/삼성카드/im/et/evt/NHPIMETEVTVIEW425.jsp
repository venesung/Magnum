...
<body style="margin:0;">
	...
	<map name="rent" id="rent">
		<area shape="rect" coords="368,1044,457,1090" alt="프리미엄회원 예매하기" href="javascript:go_start('P');"/>
		<area shape="rect" coords="368,1099,457,1125" alt="예매확인/취소" href="javascript:PopReserveConfirm('01107','15160')"/>
		<area shape="rect" coords="586,1044,674,1089" alt="일반회원 예매하기" href="javascript:go_start('N');"/>
		<area shape="rect" coords="586,1099,674,1126" alt="예매확인/취소" href="javascript:PopReserveConfirm('01107','15160')"/>		
	</map>
	<img src="/images/et/rent/event_rent.jpg" usemap="#rent" alt="박칼린의 연출과 브라이언의 뮤지컬 데뷔작으로 기대되는 뮤지컬 렌트" />
