...
<title>뮤지컬 시카고 1+1 이벤트 - 삼성카드</title>
	...
	function go_start() {
		...
		%>
			...
			<%}else if( beginDateYNs.equals("N") && beginDateYNd.equals("N") && beginDateYNb.equals("N")){ %>
			  	alert("<%=beginMsgs %>");
			  	window.open('/html/event/precicago/pop_02.html', 'popup2', 'width=540px, height=610px, menubar=no, toolbar=no, location=no, status=no, scrollbars=yes');
			  	return;
		  	<%}else{ %>
...
<img src="/html/event/precicago/images/event_chicago.jpg" alt="SAMSUNGCARD SELECT08 뮤지컬 시카고" border="0" usemap="#rp" />
...
<map name="rp" id="rp">
<area shape="rect" coords="48,2542,286,2581" href="#" alt="1+1예매 및 티켓 수령 방법" title="새창" onclick="window.open('/html/event/precicago/pop_01.html', 'popup', 'width=660px, height=550px, menubar=no, toolbar=no, location=no, status=no, scrollbars=no');" />
<area shape="rect" coords="294,2543,474,2582" href="#" onclick="go_start();" alt="티켓예매 바로가기" title="새창" />
<area shape="rect" coords="481,2543,680,2580" href="#" onclick="fnTicketCancel();" alt="예매확인 및 취소하기" title="새창" />
</map>
